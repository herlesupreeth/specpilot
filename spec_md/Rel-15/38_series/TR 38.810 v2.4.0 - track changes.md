...
3.  12 latitudes (16.36deg) and amples and weights; no additional mean
...
![](./media/image32.png){width="5.104166666666667in" height="0.3125in"},

Where ![](./media/image33.png){width="8.333333333333333e-2in"
height="0.18055555555555555in"} denotes the reflection coefficient and
![](./media/image34.png){width="0.20833333333333334in"
...
![](./media/image36.png){width="6.013194444444444in" height="0.2125in"}
...
![](./media/image37.png){width="3.9930555555555554in"
...
with rather simple complexity of the switch box similar to a current sub
6GHz test setup. It should be noted that the switch unit is
significantly less complex than a state-of-the-art switch unit currently
used for conformance tests.

![](./media/image39.wmf){width="6.999305555555556in"
...
![](./media/image40.wmf){width="5.999305555555556in"
...
![](./media/image41.wmf){width="2.0145833333333334in"
...
![](./media/image42.wmf){width="4.692361111111111in"
height="0.2013888888888889in"} (1)

![](./media/image43.wmf){width="4.692361111111111in"
height="0.2013888888888889in"} (2)

Worst case can be assumed as the case that the phase of signal and
leakage are same, and it can be shown as follows

![](./media/image44.png){width="3.6256944444444446in"
height="0.27361111111111114in"} (3)

![](./media/image45.png){width="3.602777777777778in"
height="0.30069444444444443in"} (4)

If we put equations (3) in (1) and (4) in (2), we get following 2
equations.

![](./media/image46.wmf){width="3.542361111111111in" height="0.34375in"}
(5)

![](./media/image47.wmf){width="3.542361111111111in"
height="0.3645833333333333in"} (6)

Difference of amplitude between the case that there is a leakage and not
can be calculated as follows.

\- Amplitude when there is not the leakage:
![](./media/image48.wmf){width="0.14930555555555555in"
height="0.18125in"}

\- Amplitude when there is the leakage (Worst):
![](./media/image49.wmf){width="0.975in" height="0.36319444444444443in"}

![](./media/image50.wmf){width="4.191666666666666in" height="0.69375in"}

For example, if the XPD = -30dB, the calculated value can be as follows.

![](./media/image51.wmf){width="3.1326388888888888in"
height="0.35625in"}
...
![](./media/image52.wmf){width="1.5402777777777779in"
...
+----------+----------+----------+----------+----------+----------+---+
| UID      | Des      | **Unc    | **Dist   | **D      | **       |   |
|          | cription | ertainty | ribution | ivisor** | Standard |   |
|          | **of     | Value**  | of the   |          | unc      |   |
|          | unc      |          | proba    |          | ertainty |   |
|          | ertainty |          | bility** |          | (σ)      |   |
|          | contri   |          |          |          | \[dB\]** |   |
...
**Table B.2.1.2-1: Uncertainty contributions for test with defined DL
...
**Table B.2.1.3-1: Uncertainty assessment for test with defined DL SNR
at reference point**
...
B.3.1.5, but the values related to the test system may be different and
may provide a different testable SNR range.
...
**Table** **B.2.2.2-1:** **Uncertainty contributions for test with
defined DL SNR** **at reference point**
...
**Table** **B.2.2.2-2:** **Uncertainty contributions for** **DL absolute
power level at reference point** **(D = 15 cm)**
...
> \- For the purpose of uncertainty assessment, the radiating antenna
> aperture of the DUT is denoted as D, and the uncertainty assessment
> has been derived for the case of D = 15 cm

The uncertainty contributions depend on the parameter being controlled
and/or the measurement being made. A separate table is provided for
each.

**Table** **B.2.2.3-1:** **Uncertainty assessment for test with defined
DL SNR** **at reference point**
...
**Table** **B.2.2.3-2:** **Uncertainty assessment for** **DL absolute
power level at reference point** **(D = 15 cm)**
...
**Table B.3.1.3-1: Uncertainty assessment for T-put test with** defined
SNR at reference point
...
in this subclause allow this SNR degradation to be assessed over a range
of scenarios.
...
performance capability of demodulation of DUT under such SNR
environment. Such SNR environment is generated by the test system by
injecting both desired signal and artificial AWGN noise. To fulfil the
purpose of the test, the configured SNR should be accurate enough at the
UE receiver. If the absolute power level of the signal and noise from
the test system is too low, then the SNR would be degraded due to the
UE's internal noise. The actual SNR at the UE receiver can be considered
as follows:

SNR\_actual = S\_rx/(N\_rx+Nktb\*F\_UE)

where,

> F\_UE : Noise figure (NF) of the UE
>
> Nktb : Thermal noise level
>
> S\_rx, N\_rx : Received signal power for the desired signal and AWGN
> (artificial noise) respectively, at reference point (UE baseband
> receiver port).
>
> SNR\_target = S\_rx /N\_rx = S\_tx/N\_tx, which is given parameter for
> demodulation test
>
> S\_tx, N\_tx : Transmit signal power for the desired signal and AWGN
> (artificial noise), respectively
>
> S\_rx = S\_tx \* PL(d)\* G\_UE \* IL\_UE
>
> N\_rx = N\_tx \* PL(d) \* G\_UE \* IL\_UE
>
> S\_tx = P\_tx
>
> N\_tx = S\_tx / SNR\_target
>
> P\_tx: Probe TX power
>
> PL(d): The free space pathloss, which depends on the distance d
> between the test antenna and DUT.
>
> G\_UE: UE receive antenna array gain
>
> IL\_UE: UE receiver implementation loss
>
> Note: In the above, all symbols are represented as linear (non-dB)
> values.

We note that in calculations for EIS, in addition to the UE receiver
antenna gain and UE receiver noise figure, a term "Total implementation
loss" is also used. The effect of this is to degrade the effective noise
figure further. Noting also that the UE receiver antenna gain, noise
figure and implementation loss depend on frequency, the values in Table
B.3.1.5.1-1 have been used for assessing the testable SNR range:

**Table B.3.1.5.**1-1: Assumed UE parameters

  --------------------------------- ------- ------- --------
                                    24GHz   43GHz   
  UE Antenna Gain (G\_UE)           7       8       dBi
  UE Noise Figure (F\_UE)           10      12      dB
  UE Implementation loss (IL\_UE)   -10     -11     dB
  Nktb                              -174    -174    dBm/Hz
  --------------------------------- ------- ------- --------

The possible transmitted signal strengths from the test antenna S\_tx,
N\_tx depend on the capability of test system. The feasible transmit
power depends on the conducted cable losses, the Test system transmit
antenna gain and the final amplifier characteristic, especially the P1dB
compression point. Considering the cable losses, probe antenna gain of
12dB and commercially available mmWave Amplifiers, and the crest factor
of the downlink signal (not to cause additional EVM error from test
system side), the feasible transmit power from the probe antenna is
calculated below.
...
**Table B.3.1.5.**1-2: Assumed Test system parameters
  ...
  ------------------------- ---------------------------- --------- ---------
                            24GHz                        43GHz     
  P1dB amplifier power      +23                          +23       dBm
  Backoff from P1dB         -13                          -13       dB
  Cable loss                -4                           -7        dB
  Probe antenna gain        12                           12        dB
  Power from Test antenna   **+18**                      **+15**   **dBm**
...
**Table B.3.1.5.**1-3: Free Space path loss
  ...
  ------------------- ------- ------- ----
                      24GHz   43GHz   
  \@0.5m separation   -54.0   -59.1   dB
  \@0.7m separation   -57.0   -62.0   dB
  \@1.0m separation   -60.1   -65.1   dB
  ------------------- ------- ------- ----
...
The example calculation of SNR error in Table B.3.1.5.1-1 illustrates
the method for a specific set of parameters. It starts by calculating
the wanted signal S\_tx and wanted noise N\_tx at the test antenna, and
calculates the wanted spectral densities seen by the UE receiver. It
then calculates the unwanted noise, based on the noise figure of the UE
receiver and thermal noise. The wanted and unwanted noise contributions
are combined, to re-estimate the actual SNR seen by the UE receiver.

The set of parameters chosen here is not a recommendation, they are
chosen only to illustrate the method.
...
24GHz, 0.7m
  ...
  ------------------------------------ ------------------------ ------------ ------------- -------------
                                       Signal                   Noise        UE            
  Target SNR                           20                                    dB            
  Power from Test antenna              +18                      -2                         dBm/1GHz
  Free space path loss \@0.7m, 24GHz   -57                      -57                        dB
  Scale power 1GHz to 1Hz              -90                      -90                        dB
  UE Antenna Gain                      +7                       +7                         dB
  UE Implementation loss               -10                      -10                        dB
  Wanted powers                        **-132**                 **-152**                   **dBm/1Hz**
  Thermal Noise                                                              -174          dBm/1Hz
  UE Noise figure                                                            +10           dB
  UE Noise                                                                   **-164**      **dBm/1Hz**
  S\_rx and N\_rx                      **-132**                 **-151.7**   **dBm/1Hz**   
...
Based on the parameters in Tables B.3.1.5.1-1 to B.3.1.5.1-3, the SNR
error is shown versus target SNR:

![](./media/image53.png){width="6.706944444444445in"
height="4.4006944444444445in"}

**Figure B.3.1.5.3-1: SNR Error versus SNR target, 0.7m distance @
24GHz**

![](./media/image54.png){width="6.706944444444445in"
height="4.4006944444444445in"}

**Figure B.3.1.5.3-2: SNR Error versus SNR target, 0.7m distance @
43.5GHz**

![](./media/image55.png){width="6.706944444444445in"
height="4.4006944444444445in"}**Figure B.3.1.5.3-3: SNR Error versus SNR
target, 0.5m distance @ 24GHz**

![](./media/image56.png){width="6.706944444444445in"
height="4.4006944444444445in"}**Figure B.3.1.5.3-4: SNR Error versus SNR
target, 0.5m distance @ 43.5GHz**
...
**Table B.3.3.3-1: Uncertainty assessment for T-put test with defined
SNR at reference point**
...
#### B.3.3.5 Assessment of testable SNR range {#b.3.3.5-assessment-of-testable-snr-range .list-paragraph}
...
reference coordinate system, reused from the LTE MIMO OTA definition in
\[5\], is provided in Figure C.1-1 below.

![](./media/image57.wmf){width="1.7479166666666666in"
...
in order to define unambiguous DUT positioning requirements for the test

\- An understanding of the origin of the test system (i.e. the direction
in which the x-axis points inside the test chamber) is needed in order
to define unambiguous DUT orientation, DUT beam, signal, interference,
...
|             |             |             | angle       |             |
+-------------+-------------+-------------+-------------+-------------+
| Free space  | Ψ=0;\       | θ~Link;\    | Θ~Meas;\    | ![](./med   |
|             | Θ=0;\       | ~φ~Link~    | ~φ~Meas~    | ia/image58. |
|             | Φ=0         |             |             | wmf){width= |
|             |             | with        | with        | "1.98819444 |
|             |             | p           | p           | 44444444in" |
|             |             | olarization | olarization | height="    |
|             |             | reference   | reference\  | 2.325694444 |
|             |             | Pol~Link~ = | Pol~Meas~ = | 4444443in"} |
|             |             | θ or ~;\    | θ or ~;\    |             |
|             |             | ~φ          | ~φ          |             |
+-------------+-------------+-------------+-------------+-------------+
| NOTE 1: A   |             |             |             |             |
...
C.2-1 are defined as single values or ranges of values, such that DUT
positioning, DUT beam direction, and angles of the signal,
link/interferer, and measurement are specified.
...
![](./media/image60.wmf){width="2.19375in" height="1.0in"}

![](./media/image61.wmf){width="2.2222222222222223in" height="1.0in"}

and

![](./media/image62.wmf){width="2.125in" height="1.0in"}.

with the respective angles of rotation, *α*, *β*, *γ* and

![](./media/image63.wmf){width="0.8888888888888888in" height="1.0in"}

Additionally, any translation of the DUT can be defined with the
translation matrix

![](./media/image64.wmf){width="1.875in" height="1.0in"}

with offsets t~x~, t~y~, t~z~ in x, y, and z, respectively and with

![](./media/image65.wmf){width="0.875in" height="1.0in"}
...
describes an initial rotation of the DUT around the z axis with angle
*γ*, a subsequent rotation around the y axis with angle *β*, and a final
rotation around the x axis with angle *α*. After those rotations, the
...
C.3-1 and C.3-2 illustrate how to reposition the DUT in a distributed
axes and combined axes system, when the beam peak is directed to the
DUTs upper hemisphere (DUT orientation 1) or the DUTs lower hemisphere
(DUT orientation 2).

![](./media/image67.wmf){width="4.502083333333333in"
height="2.973611111111111in"}

**Figure** **C.3-1: DUT re-positioning for** **distributed-axes system**

![](./media/image68.wmf){width="6.690277777777778in"
height="2.5819444444444444in"}

**Figure** **C.3-2:** **DUT re-positioning for** **combined-axes
system**
...
quiet zone for the baseline measurement system, subclause 5.2.1 and the
simplified baseline setup for centre of beam measurements, subclause
5.2.2.

D.2 Procedure to characterize the quality of the quiet zone for the baseline system
===================================================================================
...
![](./media/image69.png){width="4.999305555555556in"
...
![](./media/image70.wmf){width="6.688194444444444in"
height="2.9618055555555554in"}

Figure D.2.1-1: Directivity mask

![](./media/image71.wmf){width="6.688194444444444in"
height="2.9618055555555554in"}

Figure D.2.1-2: 2xHPBW-E mask

![](./media/image72.wmf){width="6.688194444444444in"
height="2.9618055555555554in"}
...
zone shall be considered a sphere with radius of R=7.5cm. Alternate
quiet zone sizes can be defined for larger DUTs.
...
![](./media/image73.png){width="4.497916666666667in"
...
![](./media/image74.wmf){width="4.0in" height="3.0208333333333335in"}
...
![](./media/image75.wmf){width="5.583333333333333in"
...
![](./media/image76.png){width="5.394444444444445in"
...
![](./media/image78.wmf){width="6.6930555555555555in"
...
![](./media/image80.wmf){width="6.694444444444445in"
...
When facing the z-axis, *γ* = 0^o^ and *γ* = 180^o^, the antenna does
not need to be evaluated for the 8 different rotations around the z
axis. A single roll orientation is sufficient since those orientations
are unique. Due to the pedestal, distributed-axes systems are not able
to measure towards the *γ* =180^o^ direction; for those systems, the
...
zone analysis is sufficient only for *γ * = 0^o^, 45^o^, 90^o^, 135^o^,
and 180^o^~.~
...
zone analysis is sufficient only for *β * = 0^o^, 45^o^, 90^o^, 135^o^,
and 180^o^~.~
...
![](./media/image87.png){width="5.580555555555556in"
...
![](./media/image88.wmf){width="2.9833333333333334in"
height="2.9972222222222222in"}![](./media/image89.wmf){width="3.2375in"
...
![](./media/image90.png){width="3.3354166666666667in"
...
![](./media/image91.png){width="5.2375in" height="3.0027777777777778in"}
...
![](./media/image92.png){width="3.1368055555555556in"
height="2.4506944444444443in"}

Figure E.2.1-1: Amplitude variation across the quiet zone of 15cm

![](./media/image93.png){width="3.129861111111111in" height="2.5125in"}
...
cylindrical sources) needs to be minimized using edge treatment. Common
edge treatments are:
...
\<Editor's note: figures could not be properly copied from the related
TP and are needed to correct this figure\>

Figure E.2.2.1-1: Reflector Types -- Rolled edge (left), Serrated Edge
(right)
...
power (EIRP) in subclause 10.3.1 as well as for OTA sensitivity (EIS) in
subclause 10.3.2.

The theoretical analysis behind this statement can be as follows:

C.A. Balanis (in his book "Antenna Theory: Analysis and Design," Ch. 3,
pp. 127-132) provides a thorough discussion of reciprocity and its
...
![](./media/image107.png){width="4.15625in"
...
![](./media/image108.png){width="1.3583333333333334in"
height="0.31666666666666665in"} (4)
...
![](./media/image118.png){width="4.886111111111111in"
...
![](./media/image119.png){width="6.788194444444445in"
height="2.0819444444444444in"}

Figure E.3-3: CATR- Amplitude Reciprocity (Vertical cut)

![](./media/image120.png){width="6.998611111111111in"
height="2.10625in"}
...
subclause, an analysis of the impact of this uncertainty for CATR is
...
![](./media/image121.png){width="6.846527777777778in"
...
![](./media/image122.png){width="6.848611111111111in"
...
![](./media/image123.png){width="5.896527777777778in"
...
![](./media/image124.png){width="5.198611111111111in"
...
![](./media/image125.png){width="3.1013888888888888in"
...
![](./media/image126.png){width="1.0in" height="0.5465277777777777in"}
...
![](./media/image128.png){width="6.397222222222222in"
...
![](./media/image129.png){width="3.3645833333333335in" height="2.0in"}
...
-   The number of spherical wave that are needed to fully represent the
    antenna increases as the DUT moves further away from the center of
