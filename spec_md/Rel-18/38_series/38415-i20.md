...
Each PDU session User Plane protocol instance and PDU Set Information User Plane protocol instance are associated to one PDU Session.

In this version of the specification, the PDU Session User Plane protocol data is conveyed by GTP-U protocol means, more specifically, by means of the "PDU Session Container" GTP-U Extension Header as defined in TS 29.281 [3].

In this version of the specification, the PDU Set Information User Plane protocol data is conveyed by GTP-U protocol means, more specifically, by means of the "PDU Set Information Container" GTP-U Extension Header as defined in TS 29.281 [3].
...
If the ECN Marking or Congestion Information Reporting Status is active for a QoS flow indicated by the QFI field, the UL PDU SESSION INFORMATION frame should include an UL Congestion Information field and/or a DL Congestion Information field. The UPF shall, if supported, use this information to perform ECN marking at UPF or information exposure as specified in TS 23.501 [5].
...
| PDU Type (=0)              | PDU Type (=0)              | PDU Type (=0)              | PDU Type (=0)              | QMP                        | SNP                        | MSNP                       | Spare                      | 1                  |
| PPP                        | RQI                        | QoS Flow Identifier        | QoS Flow Identifier        | QoS Flow Identifier        | QoS Flow Identifier        | QoS Flow Identifier        | QoS Flow Identifier        | 1                  |
| PPI                        | PPI                        | PPI                        | Spare                      | Spare                      | Spare                      | Spare                      | Spare                      | 0 or 1             |
| DL Sending Time Stamp      | DL Sending Time Stamp      | DL Sending Time Stamp      | DL Sending Time Stamp      | DL Sending Time Stamp      | DL Sending Time Stamp      | DL Sending Time Stamp      | DL Sending Time Stamp      | 0 or 8             |
| DL QFI Sequence Number     | DL QFI Sequence Number     | DL QFI Sequence Number     | DL QFI Sequence Number     | DL QFI Sequence Number     | DL QFI Sequence Number     | DL QFI Sequence Number     | DL QFI Sequence Number     | 0 or 3             |
| DL MBS QFI Sequence Number | DL MBS QFI Sequence Number | DL MBS QFI Sequence Number | DL MBS QFI Sequence Number | DL MBS QFI Sequence Number | DL MBS QFI Sequence Number | DL MBS QFI Sequence Number | DL MBS QFI Sequence Number | 0 or 4             |
...
|--------------------------------|--------------------------------|--------------------------------|--------------------------------|--------------------------------|--------------------------------|--------------------------------|--------------------------------|---------------------------|
| 7                              | 6                              | 5                              | 4                              | 3                              | 2                              | 1                              | 0                              | Number of Octets          |
| PDU Type (=1)                  | PDU Type (=1)                  | PDU Type (=1)                  | PDU Type (=1)                  | QMP                            | DL Delay Ind.                  | UL Delay Ind.                  | SNP                            | 1                         |
| N3/N9 Delay Ind.               | New IE Flag                    | QoS Flow Identifier            | QoS Flow Identifier            | QoS Flow Identifier            | QoS Flow Identifier            | QoS Flow Identifier            | QoS Flow Identifier            | 1                         |
| DL Sending Time Stamp Repeated | DL Sending Time Stamp Repeated | DL Sending Time Stamp Repeated | DL Sending Time Stamp Repeated | DL Sending Time Stamp Repeated | DL Sending Time Stamp Repeated | DL Sending Time Stamp Repeated | DL Sending Time Stamp Repeated | 0 or 8                    |
| DL Received Time Stamp         | DL Received Time Stamp         | DL Received Time Stamp         | DL Received Time Stamp         | DL Received Time Stamp         | DL Received Time Stamp         | DL Received Time Stamp         | DL Received Time Stamp         | 0 or 8                    |
| UL Sending Time Stamp          | UL Sending Time Stamp          | UL Sending Time Stamp          | UL Sending Time Stamp          | UL Sending Time Stamp          | UL Sending Time Stamp          | UL Sending Time Stamp          | UL Sending Time Stamp          | 0 or 8                    |
| DL Delay Result                | DL Delay Result                | DL Delay Result                | DL Delay Result                | DL Delay Result                | DL Delay Result                | DL Delay Result                | DL Delay Result                | 0 or 4                    |
| UL Delay Result                | UL Delay Result                | UL Delay Result                | UL Delay Result                | UL Delay Result                | UL Delay Result                | UL Delay Result                | UL Delay Result                | 0 or 4                    |
| UL QFI Sequence Number         | UL QFI Sequence Number         | UL QFI Sequence Number         | UL QFI Sequence Number         | UL QFI Sequence Number         | UL QFI Sequence Number         | UL QFI Sequence Number         | UL QFI Sequence Number         | 0 or 3                    |
| N3/N9 Delay Result             | N3/N9 Delay Result             | N3/N9 Delay Result             | N3/N9 Delay Result             | N3/N9 Delay Result             | N3/N9 Delay Result             | N3/N9 Delay Result             | N3/N9 Delay Result             | 0 or 4                    |
...
| Spare                          | Spare                          | Spare                          | Spare                          | Spare                          | Spare                          | Spare                          | D1 UL PDCPDelay  Result Ind    | 0 or 1                    |
...
Bit 1 of New IE Flags Octet in UL PDU SESSION INFORMATION (PDU Type 1) indicates if the UL Congestion Information is present (1) or not (0).

Bit 2 of New IE Flags Octet in UL PDU SESSION INFORMATION (PDU Type 1) indicates if the DL Congestion Information is present (1) or not (0).
...
The PDU Set Information UP layer uses the services of the Transport Network Layer in order to send its packets over the interface.
...
The purpose of the Transfer of DL PDU Set Information procedure is to send PDU Set information and indication of End of Data Burst related to a QoS flow from UPF to NG-RAN node or between NG-RAN nodes, or from gNB-CU to gNB-DU.

The DL PDU SET INFORMATION frame includes a QoS Flow Identifier (QFI) field associated with the transferred packet. The NG-RAN shall use the received QFI to determine the QoS flow and QoS profile which are associated with the received packet.

The DL PDU SET INFORMATION frame includes PDU Set Sequence Number, PDU Sequence Number within a PDU Set, PDU Set Importance, End of Data Burst and End PDU of the PDU Set as specified in TS 23.501 [5].
...
This frame format is defined to allow the NG-RAN node or gNB-DU to receive PDU Set Information and indication of End of Data Burst of a QoS flow.
...
|---------------------------|---------------------------|---------------------------|---------------------------|---------------------------|---------------------------|---------|---------|--------------------|
| 7                         | 6                         | 5                         | 4                         | 3                         | 2                         | 1       | 0       | Number of Octets   |
| PDU Type (=0)             | PDU Type (=0)             | PDU Type (=0)             | PDU Type (=0)             | EDB                       | EPDU                      | PSSI    | Spare   | 1                  |
| QoS Flow Identifier (QFI) | QoS Flow Identifier (QFI) | QoS Flow Identifier (QFI) | QoS Flow Identifier (QFI) | QoS Flow Identifier (QFI) | QoS Flow Identifier (QFI) | PSSN    | PSSN    | 2                  |
| PSSN                      | PSSN                      | PSSN                      | PSSN                      | PSSN                      | PSSN                      | PSSN    | PSSN    | 2                  |
| Spare                     | Spare                     | Spare                     | Spare                     | PSI                       | PSI                       | PSI     | PSI     | 1                  |
| PSN                       | PSN                       | PSN                       | PSN                       | PSN                       | PSN                       | PSN     | PSN     | 1                  |
| PSSize                    | PSSize                    | PSSize                    | PSSize                    | PSSize                    | PSSize                    | PSSize  | PSSize  | 0 or 3             |
| Padding                   | Padding                   | Padding                   | Padding                   | Padding                   | Padding                   | Padding | Padding | 0-3                |
...
**Description:** The PDU Type indicates the structure of the PDU Set UP frame. The field takes the value of the PDU Type it identifies; i.e. "0" for PDU Type 0. The PDU type is in bit 4 to bit 7 in the first octet of the frame.
...
**Description:** This parameter indicates the importance of the current PDU Set compared to other PDU Sets within the same QoS flow. Lower values shall indicate a higher importance with the exception that value “0” means sender cannot define importance. PDU Set with the highest importance PDU Set is indicated by 1 and the lowest importance PDU Set is indicated by 15.
...
**Description:** This parameter indicates the sequence number of the PDU Set to which the current PDU belongs acting as an identifier for the PDU Set.
...
**Description:** This parameter indicates the sequence number of the current PDU within the PDU Set. The PSN shall be set to 0 for the first PDU in the PDU Set and incremented monotonically for every PDU in the PDU set in order of transmission from the sender.
...
**Description:** This parameter indicates the total size of all PDUs in bytes of the PDU Set to which the current PDU belongs.
