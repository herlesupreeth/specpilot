3GPP TS 38.509 V18.0.0 (2025-06)
...
STxMP	Simultaneous Transmission with Multi-Panel
...
2&gt; if TEST\_LOOP\_MODE\_C\_ACTIVE = TRUE or TEST\_LOOP\_MODE\_D\_ACTIVE = TRUE or TEST\_LOOP\_MODE\_E\_ACTIVE = TRUE or TEST\_LOOP\_MODE\_F\_ACTIVE = TRUE or TEST\_LOOP\_MODE\_G\_ACTIVE = TRUE or TEST\_LOOP\_MODE\_H\_ACTIVE = TRUE or TEST\_LOOP\_MODE\_I\_ACTIVE = TRUE:
...
For Broadcast MRB, upon receiving a MBS packet on the Broadcast MRB with Identity of the logical channel of broadcast MTCH configured in CLOSE UE TEST LOOP when operating in RRC\_IDLE or RRC\_CONNECTED or RRC\_INACTIVE mode with UE test loop mode C active the UE shall:
...
For Multicast MRB, upon receiving a MBS packet on the Multicast MRB with MRB Identity configured in CLOSE UE TEST LOOP when operating in RRC\_CONNECTED mode with UE test loop mode C active the UE shall:
...
NOTE: For UEs Release 18 and above supporting STxMP, unlock all active UE antenna patterns
...
| 8        | 7        | 6        | 5        | 4        | 3        | 2        | 1        | bit no.   |
|----------|----------|----------|----------|----------|----------|----------|----------|-----------|
| Reserved | Reserved | Reserved | Reserved | Reserved | Reserved | Reserved | C0       | octet 1   |
| A8       | A7       | A6       | A5       | A4       | A3       | A2       | A1       | octet 2   |
| A0       | Reserved | Reserved | Reserved | Reserved | Reserved | Reserved | Reserved | octet 3   |
...
| 8        | 7        | 6        | 5        | 4        | 3        | 2   | 1   | bit no.   |
|----------|----------|----------|----------|----------|----------|-----|-----|-----------|
| Reserved | Reserved | Reserved | Reserved | Reserved | Reserved | E1  | E0  | octet 3   |
...
| 8   | 7   | 6   | 5   | 4   | 3   | 2   | 2        | 1        | bit no.   |
|-----|-----|-----|-----|-----|-----|-----|----------|----------|-----------|
| A9  | A8  | A7  | A6  | A5  | A4  | A4  | A3       | A2       | octet 1   |
| A1  | A0  | B3  | B2  | B1  | B0  | B0  | Reserved | Reserved | octet 2   |
| C2  | C1  | C0  | D3  | D2  | D1  | D1  | D0       | Reserved | octet 3   |
| E13 | E12 | E11 | E10 | E9  | E8  | E8  | E7       | E6       | octet 4   |
| E5  | E4  | E3  | E2  | E1  | E0  | E0  | Reserved | Reserved | octet 5   |
...
| 2024-06          | RAN#104          | R5-253401        | 0085             | 1                | F                | Modification of Beamlock test function to support locking two TX beams from two panels simultaneously | 18.0.0           |