...
Note: The azimuth angles of
$\left( \phi_{n,model} - \mu_{\phi,model} \right)\ $should be wrapped
...
Note: The resulting scaled ray angle may or may not achieve the desired
angle mean and the desired rms angle spread.
...
#########  Annex B: Change history
  ...
  **Date**             **Meeting**   **TDoc**     **CR**   **Rev**   **Cat**   **Subject/Comment**                                                                                                                                                                                                                                          **New version**
  ...
  2023-12              RAN\#102      RP-233727    0025     \-        F         CR correcting scaling of angles for CDL model and a figure reference                                                                                                                                                                                         17.1.0
