...
\[12\] 3GPP TS 38.521-4: \"NR; User Equipment (UE) conformance
...
##### UE policy section management list {#ue-policy-section-management-list .H6}
...
20\. Observe that the throughput in step 18 is not lower than the
...
12\. Using the Application Client Simulator to simulate APP A, begin
uplink data transfer from UE to the Application Server Simulator.

13\. Repeat steps 6-8 to get the average application layer data
throughput of the data traffic of simulated APP A.

14\. Observe that the throughput in step 13 is not lower than the
throughput benchmark in step 8.
...
To measure the performance of single services in application layer of
the 5G NR UE with the different resource allocation of the same slice.
...
Configurations of PUSCH and PUCCH are specified in TS 38.521-1 \[13\]
Annex G. Configure the TBsize, UL RMC, PDCP size from TS 38.521-4 \[12\]
Annex A.2 with the exception of using half of the allocated resource
block at step 5-7. Configure the TBsize, UL RMC, PDCP size from TS
38.521-4 \[12\] Annex A.2 at step 9-13.
...
14\. Observe that the throughput in step 13 is two times of the
throughput benchmark in step 8.
...
A.2.1.1.4.2 are performed except the REGISTRATION ACCEPT message is
defined in Table A.3.2.1.4.2-1 and *MANAGE UE POLICY COMMAND message is
defined in* Table A.3.2.2.4.2-1.
...
3\. The UE transmits an UL NAS TRANSPORT message and PDU SESSION
ESTABLISHMENT REQUEST message. Observe the right S-NSSAI value are
selected.
...
8\. Using the simulated APP A and APP B, begin uplink data transfer from
UE to the Application Server Simulator.

9\. Wait for 15 seconds and then start to measure the throughput result
of simulated APP A and latency result of simulated APP B in application
...
11\. Calculate and record the average application layer data throughput
of simulated APP A and latency of simulated APP B across three
iterations.

12\. The SS transmits a DL NAS TRANSPORT message including UE Policy
Container and MANAGE UE POLICY COMMAND message to update URSP rules.

13\. Repeat step 2-4 with the message exception defined in Table
A.3.2.2.4.2-5 and A.3.2.2.4.2-6

14\. Repeat step 5-7 with the message exception defined in Table
A.3.2.2.4.2-5 and A.3.2.2.4.2-6

15\. Repeat step 8-11 to get the average application layer data
throughput of simulated APP A and latency of simulated APP B in
parallel.

16\. Observe that the throughput in step 15 is not lower than the
throughput benchmark in step 11 and the latency in step 15 is not higher
than the latency benchmark in step 11.
...
Table A.3.3.2.4.2-2: UL NAS Transport (step 3, step 6)
  ...
  S-NSSAI                                              Not Present                         
  Length of S-NSSAI contents                           \'00000100\'B   SST and SD          
  SST                                                  \'00000001\'B   eMBB                step 3
                                                       \'00000010\'B   URLLC               step 6
  SD                                                   0x000001                            
...
Table A.3.3.2.4.2-3: PDU SESSION ESTABLISHMENT ACCEPT (step 4, step 7)
  ...
  S-NSSAI                                                                    
  Length of S-NSSAI contents                    \'00000100\'B   SST and SD   
  SST                                           \'00000001\'B   eMBB         step 4
                                                \'00000010\'B   URLLC        step 7
  SD                                            0x000001                     
