3GPP TS 38.322 V18.2.0 (2024-12)
...
This counter counts the number of retransmissions of an RLC SDU or RLC SDU segment (see clause 5.3.2). There is one RETX\_COUNT counter maintained per RLC SDU. This counter is reset to zero for each RLC SDU when indicated by upper layer.
...
| 2024-06          | RP-104           | RP-241574        | 0056             | -                | B                | Clarification on RETX_COUNT during an LTM cell switch                     | 18.1.0           |
