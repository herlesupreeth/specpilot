...
|                    | > angles of LCS are defined according to TS    |
|                    | > 38.901 \[15\].                               |
|                    |                                                |
...
|                    | drift measurement shall be the Rx antenna of   |
|                    | the UE.                                        |
+====================+================================================+
| **Applicable for** | RRC\_CONNECTED                                 |
+--------------------+------------------------------------------------+
...
+----------------+----------------------------------------------------+
| **Definition** | UL reference signal carrier phase (RSCP) is        |
|                | defined as the phase of the channel response at    |
|                | the 1^st^ path delay derived from the resource     |
|                | elements carrying sounding reference signals (SRS) |
|                | configured for the measurement.                    |
|                |                                                    |
|                | UL RSCP is associated with the center frequency of |
|                | the transmission bandwidth of the SRS for          |
|                | positioning purposes configured for the            |
|                | measurement.                                       |
|                |                                                    |
...
|                | >                                                  |
|                | > \- for type 1-O or 2-O base station TS 38.104    |
|                | > \[9\]: the Rx antenna (i.e., the centre location |
|                | > of the radiating region of the Rx antenna),      |
|                | >                                                  |
|                | > \- for type 1-H base station TS 38.104 \[9\]:    |
|                | > the Rx Transceiver Array Boundary connector.     |
+----------------+----------------------------------------------------+
