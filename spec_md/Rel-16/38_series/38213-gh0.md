...
![](./media/image296.wmf) is a number of ![](./media/image297.wmf)
symbols equal to the product of a number of symbols per slot,
![](./media/image158.wmf), and the minimum of the values provided by
*k2* in *PUSCH-ConfigCommon* for active UL BWP ![](./media/image92.wmf)
of carrier ![](./media/image65.wmf) *of* serving cell
...
\- If the UE has reached maximum power for active UL BWP
![](./media/image92.wmf) of carrier ![](./media/image65.wmf) *of*
serving cell ![](./media/image66.wmf) at SRS transmission occasion
...
![](./media/image92.wmf) of carrier ![](./media/image65.wmf) *of*
serving cell ![](./media/image66.wmf) is provided by higher layers
...
DCI format 2\_3 ![](./media/image309.wmf) symbols before a first symbol
of SRS transmission occasion ![](./media/image133.wmf), where absolute
values of ![](./media/image310.wmf) are provided in Table 7.1.1-1
...
resource in the SRS resource set ![](./media/image278.wmf); otherwise,
the update of the power control adjustment state SRS transmission
occasion ![](./media/image133.wmf) occurs at the beginning of the first
...
![](./media/image92.wmf) of carrier ![](./media/image65.wmf) of serving
cell ![](./media/image66.wmf) based on DL RS for serving cell
![](./media/image66.wmf) in transmission occasion
![](./media/image313.wmf) as

![](./media/image314.wmf) \[dBm\],

where ![](./media/image315.wmf) is the UE configured maximum output
power defined in \[8-1, TS 38.101-1\], \[8-2, TS 38.101-2\] and \[8-3,
TS 38.101-3\] for carrier ![](./media/image65.wmf) of serving cell
...
layers \[11, TS 38.321\] for the active UL BWP ![](./media/image92.wmf)
of carrier ![](./media/image65.wmf) of serving cell
![](./media/image66.wmf), and ![](./media/image317.wmf) is a pathloss
for the active UL BWP ![](./media/image92.wmf) of carrier
![](./media/image65.wmf) *based on* the DL RS associated with the PRACH
transmission on the active DL BWP *of* serving cell
![](./media/image66.wmf) and calculated by the UE in dB as
...
described in clause 13, the UE determines ![](./media/image318.wmf)
...
![](./media/image56.wmf) *is associated with a SS/PBCH block, as
described in clause 6,* *referenceSignalPower* is provided by
*ss-PBCH-BlockPower*.
...
respective transmission occasion* ![](./media/image319.wmf) *would
exceed* ![](./media/image320.wmf)*, where* ![](./media/image320.wmf) *is
the linear value of* ![](./media/image321.wmf) *in transmission
occasion* ![](./media/image319.wmf) *as defined in \[8-1, TS 38.101-1\]
for FR1* and \[8-2, TS 38.101-2\] *for FR2, the UE allocates power to*
...
symbol of transmission occasion* ![](./media/image319.wmf)*. The total
UE transmit power in a symbol of a slot is defined as the sum of the
linear values of UE transmit powers for PUSCH, PUCCH, PRACH, and SRS in
...
![](./media/image322.wmf) for transmissions on the MCG by *p-MaxEUTRA*
and a maximum power ![](./media/image323.wmf) for transmissions in FR1
on the SCG by *p-NR-FR1*.
...
![](./media/image327.wmf) is the linear value of
![](./media/image322.wmf), ![](./media/image328.wmf) is the linear value
of ![](./media/image323.wmf), and ![](./media/image329.wmf) is the
linear value of a configured maximum transmission power for EN-DC
operation as *defined in* \[8-3, TS 38.101-3\] for FR1, the UE
...
\- if UE transmission(s) in subframe ![](./media/image330.wmf) of the
MCG overlap in time with UE transmission(s) in slot
![](./media/image331.wmf) of the SCG in FR1, and
...
![](./media/image331.wmf) of the SCG so that ![](./media/image333.wmf)
in any portion of slot ![](./media/image331.wmf), where
![](./media/image334.wmf) and ![](./media/image335.wmf) are the linear
values of the total UE transmission powers in subframe
![](./media/image336.wmf) of the MCG and in slot
![](./media/image331.wmf) of the SCG in FR1, respectively. The UE is not
required to transmit in any portion of slot ![](./media/image331.wmf) of
the SCG if ![](./media/image335.wmf) would need to be reduced by more
than the value provided by *X~SCALE~* in order for
![](./media/image333.wmf) in any portion of slot
![](./media/image331.wmf) of the SCG. The UE is required to transmit in
slot ![](./media/image331.wmf) of the SCG if
![](./media/image335.wmf) would not need to be reduced by more than the
value provided by *X~SCALE~* in order for ![](./media/image333.wmf) in
all portions of slot ![](./media/image331.wmf).
...
*p-NR-FR1* and a maximum power ![](./media/image322.wmf) for
...
![](./media/image327.wmf) is the linear value of
![](./media/image322.wmf), ![](./media/image328.wmf) is the linear value
of ![](./media/image323.wmf), and ![](./media/image339.wmf) is the
linear value of a configured maximum transmission power for NE-DC
operation as *defined in* \[8-3, TS 38.101-3\] for FR1, the UE
...
\- if the UE transmission(s) in slot ![](./media/image330.wmf) of the
MCG in FR1 overlap in time with UE transmission(s) in subframe
...
the UE reduces transmission power in any portion of slot
![](./media/image330.wmf) of the MCG so that ![](./media/image341.wmf)
in all portions of slot ![](./media/image330.wmf), where
![](./media/image334.wmf) and ![](./media/image335.wmf) are the linear
...
![](./media/image92.wmf) of carrier ![](./media/image65.wmf) *of*
serving cell ![](./media/image66.wmf). A Type 3 UE power
headroom![](./media/image342.wmf) that is valid for SRS transmission
occasion ![](./media/image343.wmf) on active UL BWP
![](./media/image92.wmf) of carrier ![](./media/image65.wmf) *of*
serving cell ![](./media/image66.wmf).
...
![](./media/image92.wmf) *of* carrier ![](./media/image65.wmf) *of*
serving cell ![](./media/image66.wmf), the UE computes the Type 1 power
headroom report as
...
![](./media/image354.wmf) *of* carrier ![](./media/image355.wmf) of
serving cell ![](./media/image356.wmf) *is smaller than a* SCS
configuration ![](./media/image357.wmf) on active UL BWP
![](./media/image358.wmf) *of* carrier ![](./media/image359.wmf) of
serving cell ![](./media/image360.wmf)*, and if the UE provides a Type 1
power headroom report in a PUSCH transmission in a slot on active* UL
BWP ![](./media/image354.wmf) *that overlaps with multiple slots on
active* UL BWP ![](./media/image358.wmf)*, the UE provides a Type 1
power headroom report for the first PUSCH, if any, on the first slot of
the multiple slots on active* UL BWP ![](./media/image358.wmf) that
fully overlaps with the slot on active UL BWP ![](./media/image354.wmf).
If a UE is configured with multiple cells for PUSCH transmissions, where
a same SCS configuration on active UL BWP ![](./media/image354.wmf) *of*
carrier ![](./media/image355.wmf) of serving cell
![](./media/image356.wmf) *and* active UL BWP ![](./media/image358.wmf)
*of* carrier ![](./media/image359.wmf) of serving cell
![](./media/image360.wmf)*, and if the UE provides a Type 1 power
headroom report in a PUSCH transmission in a slot on active* UL BWP
![](./media/image354.wmf) *, the UE provides a Type 1 power headroom
report for the first PUSCH, if any, on the slot on active* UL BWP
![](./media/image358.wmf) that overlaps with the slot on active UL BWP
![](./media/image354.wmf).
...
second* PUSCH transmission on active UL BWP ![](./media/image358.wmf)
*of* carrier ![](./media/image359.wmf) of serving cell
![](./media/image363.wmf) *that overlaps with the first PUSCH
transmission if*
...
for PUSCH transmission occasion ![](./media/image344.wmf) on active UL
BWP ![](./media/image92.wmf) *of* carrier ![](./media/image364.wmf) of
serving cell ![](./media/image365.wmf), the UE computes the Type 1 power
headroom report as

![](./media/image366.wmf) \[dB\]

where ![](./media/image367.wmf) is computed assuming MPR=0 dB, A-MPR=0
dB, P-MPR=0 dB. ∆T~C~ = 0 dB. MPR, A-MPR, P-MPR and ∆T~C~ are defined in
\[8-1, TS 38.101-1\], \[8-2, TS 38.101-2\] and \[8-3, TS 38.101-3\]. The
remaining parameters are defined in clause 7.1.1 where
![](./media/image368.wmf) and ![](./media/image369.wmf) are obtained
using ![](./media/image370.wmf) and *p0-PUSCH-AlphaSetId* *=* 0*,*
![](./media/image371.wmf) is obtained using
*pusch-PathlossReferenceRS-Id =* 0, and ![](./media/image372.wmf).
...
transmission occasion ![](./media/image344.wmf) on active UL BWP
![](./media/image92.wmf) *of* carrier ![](./media/image364.wmf) *of*
serving cell $c$ and if the UE is not configured for PUSCH transmissions
on carrier ![](./media/image364.wmf) *of* serving cell $c$ and the
resource for the SRS transmission is provided by *SRS-Resource*, the UE
...
![](./media/image92.wmf) *of* carrier ![](./media/image364.wmf) *of*
serving cell $c$, and if the UE is not configured for PUSCH
transmissions on UL BWP ![](./media/image92.wmf) *of* carrier
![](./media/image364.wmf) *of* serving cell $c$ and a resource for the
reference SRS transmission is provided by *SRS-Resource*, the UE
computes a Type 3 power headroom report as
...
that are not mapped to ![](./media/image389.wmf) SS/PBCH block indexes,
no SS/PBCH block indexes are mapped to the set of PRACH occasions or
PRACH preambles. An association pattern period includes one or more
...
to transmit a PRACH no later than ![](./media/image391.wmf) msec after
the last symbol of the window, or the last symbol of the PDSCH
reception, where ![](./media/image392.wmf) is a time duration of
![](./media/image393.wmf) symbols corresponding to a PDSCH processing
time for UE processing capability 1 assuming ![](./media/image394.wmf)
...
![](./media/image35.wmf) \[6, TS 38.214\]. For a PRACH transmission
using 1.25 kHz or 5 kHz SCS, the UE determines ![](./media/image393.wmf)
...
with the HARQ-ACK information is equal to ![](./media/image397.wmf)
msec. ![](./media/image398.wmf) is a time duration of
![](./media/image399.wmf) symbols corresponding to a PDSCH processing
time for UE processing capability 1 when additional PDSCH DM-RS is
configured. For ![](./media/image34.wmf), the UE assumes
![](./media/image35.wmf) \[6, TS 38.214\].
...
For a number of ![](./media/image401.wmf) code blocks (CBs) in a
transport block, the UE determines a number of CBGs
![](./media/image402.wmf) according to clause 5.1.7.1 of \[6, TS
38.214\] and determines a number of HARQ-ACK bits for the transport
block as ![](./media/image403.wmf).
...
information bits and, if ![](./media/image405.wmf) for a transport
block, the UE generates a NACK value for the last
![](./media/image406.wmf) HARQ-ACK information bits for the transport
...
![](./media/image407.wmf) CBGs, the UE generates a NACK value for each
of the ![](./media/image407.wmf) CBGs.
...
![](./media/image408.wmf) occasion(s) on respective serving cell(s),
where the value of counter DAI in DCI format 1\_0 is according to Table
...
> slot ![](./media/image426.wmf) is before the slot for the active DL
> BWP change on serving cell ![](./media/image417.wmf) or the active UL
> BWP change on the PCell
...
Set ![](./media/image450.wmf){width="0.3909722222222222in"
height="0.2in"} -- index of a DL slot within an UL slot

while ![](./media/image451.wmf){width="1.1131944444444444in"
height="0.23055555555555557in"}

Set ![](./media/image452.wmf){width="0.2in"
height="0.1736111111111111in"} to the set of rows
...
>
> ![](./media/image461.wmf){width="0.5041666666666667in"
> height="0.2in"};
...
>
> ![](./media/image476.wmf){width="0.8in"
> height="0.23055555555555557in"};
>
> else
>
...
> end while
>
> ![](./media/image478.wmf){width="1.0in"
> height="0.23055555555555557in"}
>
> ![](./media/image465.wmf){width="0.5041666666666667in"
> height="0.2in"};
>
> Set ![](./media/image467.wmf){width="0.2in"
> height="0.16111111111111112in"} to the smallest last OFDM symbol index
...
![](./media/image481.wmf), the UE does not expect to receive more than
one PDSCH in a same DL slot associated with a same *coresetPoolIndex*
value if provided, or if *coresetPoolIndex* is not provided.
...
HARQ-ACK information bits, for a total number of
![](./media/image486.wmf) HARQ-ACK information bits, of a HARQ-ACK
codebook for transmission in a PUCCH according to the following
...
CBG. The cardinality of the set ![](./media/image487.wmf) defines a
total number ![](./media/image488.wmf) of occasions for PDSCH reception
or SPS PDSCH release for serving cell ![](./media/image489.wmf)
...
Set ![](./media/image492.wmf) to the number of serving cells configured
...
![](./media/image505.wmf) = HARQ-ACK information bit corresponding to
CBG ![](./media/image506.wmf) of the first transport block;
...
![](./media/image507.wmf) = HARQ-ACK information bit corresponding to
CBG ![](./media/image506.wmf) of the second transport block;
...
![](./media/image509.wmf), where ![](./media/image510.wmf) is the value
of *maxNrofCodeWordsScheduledByDCI* for the active DL BWP of serving
cell ![](./media/image500.wmf);
...
receives in PDSCH reception occasion ![](./media/image517.wmf) for
serving cell ![](./media/image500.wmf) if
...
provided and the PDSCH reception is scheduled by a DCI format that does
not support CBG-based PDSCH receptions, or the number of PDSCH
receptions if *harq-ACK-SpatialBundlingPUCCH* is provided or SPS PDSCH
release in PDSCH reception occasion ![](./media/image518.wmf) for
serving cell ![](./media/image500.wmf) and the UE reports corresponding
...
*harq-ACK-SpatialBundlingPUSCH*, unless the UE receives

\- only a SPS PDSCH release indicated by DCI format 1\_0 with counter
DAI field value of 1, or

\- only SPS PDSCH receptions, or

\- only a PDSCH that is scheduled by DCI format 1\_0 with a counter DAI
field value of 1 on the PCell

> in the $M_{c}$ occasions for candidate PDSCH receptions in which case
> the UE generates HARQ-ACK information only for the SPS PDSCH release
> or only for the PDSCH reception as described in clause 9.1.2.
...
$V_{\text{T-DAI}}^{\text{UL}} = 0$ unless the UE receives
...
> ![](./media/image523.wmf)= HARQ-ACK information bit for TB $t$ for
> HARQ process $h$ of serving cell $c$, if any; else,
> ![](./media/image524.wmf){width="0.5847222222222223in"
> height="0.2791666666666667in"}
>
> $j = j + 1$
...
where ![](./media/image197.wmf) is the slot **where the UE would
transmit a PUCCH with HARQ-ACK information with ACK value corresponding
to a PDSCH reception providing the *PUCCH-SpatialRelationInfo*, each
slot** consists of $N_{\text{symb}}^{\text{slot}}$ symbols as defined in
\[4, TS 38.211\], and ![](./media/image198.wmf) is the SCS configuration
for the PUCCH
...
\[4, TS 38.211\] and ![](./media/image542.wmf) corresponds to the
...
![](./media/image557.wmf) \[4, TS 38.211\] where
![](./media/image555.wmf) is provided by *initialCyclicShift* of
*PUCCH-format0* or, if *initialCyclicShift* is not provided, by the
initial cyclic shift index as described in clause 9.2.1 and
![](./media/image556.wmf) is determined from the value of one HARQ-ACK
...
![](./media/image573.wmf) are defined in clause 9.2.5.2. For PUCCH
format 3, if ![](./media/image574.wmf) is not equal
![](./media/image575.wmf) according to \[4, TS 38.211\],
![](./media/image576.wmf) is increased to the nearest allowed value of
*nrofPRBs* for *PUCCH-format3* \[12, TS 38.331\]. If
![](./media/image577.wmf), the UE transmits the PUCCH over
...
configured a periodicity ![](./media/image579.wmf) in symbols or slots
and an offset ![](./media/image580.wmf) in slots by
*periodicityAndOffset* for a PUCCH transmission conveying SR. If
![](./media/image579.wmf) is larger than one slot, the UE determines a
SR transmission occasion in a PUCCH to be in a slot with number
![](./media/image581.wmf) \[4, TS 38.211\] in a frame with number
![](./media/image582.wmf) if ![](./media/image583.wmf).

If ![](./media/image579.wmf) is one slot, the UE expects that
![](./media/image584.wmf) and every slot is a SR transmission occasion
in a PUCCH.

If ![](./media/image579.wmf) is smaller than one slot, the UE determines
a SR transmission occasion in a PUCCH to start in a symbol with index
...
the first symbol ![](./media/image590.wmf) of the earliest PUCCH or
PUSCH satisfies the first of the previous timeline conditions with the
...
![](./media/image590.wmf) is before symbol ![](./media/image591.wmf)
that is a next uplink symbol with CP starting after
![](./media/image592.wmf) after the end of the last symbol of
...
report ![](./media/image594.wmf)*.* ![](./media/image595.wmf)is defined
in \[6, TS 38.214\] and ![](./media/image542.wmf) corresponds to the
smallest SCS configuration among the SCS configurations of the PDCCHs
...
Set ![](./media/image602.wmf) to the set of resources for transmission
of corresponding PUCCHs in a single slot without repetitions where
...
if ![](./media/image613.wmf) and resource ![](./media/image614.wmf)
overlaps with resource ![](./media/image615.wmf)
...
![](./media/image620.wmf){width="0.125in"
...
The function ![](./media/image625.wmf) performs the following
pseudo-code
...
while ![](./media/image627.wmf) % the next two while loops are to
re-order the unmerged resources
...
![](./media/image644.wmf) bits representing a negative or positive SR,
in ascending order of the values of *schedulingRequestResourceId*, a
*schedulingRequestResourceId associated with
...
![](./media/image645.wmf) UCI bits in a PUCCH using a resource with
PUCCH format 2 or PUCCH format 3 or PUCCH format 4 that the UE
determines as described in clauses 9.2.1 and 9.2.3. If one of the SRs is
a positive LRR, the value of the bits indicates the positive LRR. An
all-zero value for the ![](./media/image646.wmf) bits represents a
...
![](./media/image564.wmf) CRC bits using PUCCH format 2 or PUCCH format
3 in a PUCCH resource that includes ![](./media/image565.wmf) PRBs, the
UE determines a number of PRBs ![](./media/image650.wmf) for the PUCCH
...
![](./media/image573.wmf) are defined in clause 9.2.5.2. For PUCCH
format 3, if ![](./media/image654.wmf) is not equal
![](./media/image655.wmf) according to \[4, TS 38.211\],
![](./media/image576.wmf) is increased to the nearest allowed value of
*nrofPRBs* for *PUCCH-format3* \[12, TS 38.331\]. If
![](./media/image656.wmf), the UE transmits the PUCCH over the
![](./media/image657.wmf) PRBs.
...
\- ![](./media/image486.wmf) a total number of HARQ-ACK information
bits, if any
...
\- ![](./media/image660.wmf), where ![](./media/image661.wmf) is a
number of Part 1 CSI report bits for CSI report with priority value
![](./media/image662.wmf), ![](./media/image663.wmf) is a number of Part
2 CSI report bits, if any, for CSI report with priority value
![](./media/image662.wmf) \[6, TS 38.214\], and
![](./media/image664.wmf) is a number of CSI reports that include
overlapping CSI reports

\- ![](./media/image665.wmf), where ![](./media/image666.wmf) is a
number of CRC bits, if any, for encoding HARQ-ACK, SR and Part 1 CSI
report bits and ![](./media/image667.wmf) is a number of CRC bits, if
any, for encoding Part 2 CSI report bits
...
![](./media/image668.wmf) is provided by *nrofPRBs* in *PUCCH-format2*
for PUCCH format 2 or by *nrofPRBs* in *PUCCH-format3* for PUCCH format
3, and ![](./media/image669.wmf) for PUCCH format 4

\- ![](./media/image670.wmf) for PUCCH format 2 or, if the PUCCH
resource with PUCCH format 2 includes an orthogonal cover code with
length ![](./media/image671.wmf) provided by *occ-Length*,
![](./media/image672.wmf), ![](./media/image673.wmf) for PUCCH format 3
or, if the PUCCH resource with PUCCH format 3 includes an orthogonal
cover code with length ![](./media/image674.wmf) provided by
*occ-Length*, ![](./media/image675.wmf), and ![](./media/image676.wmf)
for PUCCH format 4, where ![](./media/image677.wmf) is a number of
subcarriers per resource block \[4, TS 38.211\]
...
PUCCH symbols* ![](./media/image681.wmf) f*or PUCCH format 4* provided
by *nrofSymbols* in *PUCCH-format3* or *nrofSymbols* in *PUCCH-format4*,
...
![](./media/image683.wmf) if QPSK is the modulation scheme as indicated
by *pi2BPSK* for PUCCH format 3 or PUCCH format 4. For PUCCH format 2,
![](./media/image684.wmf)
...
![](./media/image695.wmf), or the PUCCH format 3 resource
![](./media/image695.wmf), or the PUCCH format 4 resource
![](./media/image695.wmf) and the UE selects ![](./media/image696.wmf)
CSI report(s) for transmission together with HARQ-ACK information and
SR, when any, in ascending priority value as described in \[6, TS
38.214\]
...
CSI reports bits by selecting the minimum number
![](./media/image700.wmf) of the ![](./media/image701.wmf) PRBs
satisfying ![](./media/image702.wmf) as described in clauses 9.2.3 and
9.2.5.1;

\- else, the UE selects ![](./media/image703.wmf) CSI report(s), from
the ![](./media/image664.wmf) CSI reports, for transmission together
with HARQ-ACK and SR in ascending priority value \[6, TS 38.214\], where
the value of ![](./media/image703.wmf) satisfies
![](./media/image704.wmf) and ![](./media/image705.wmf), where
![](./media/image706.wmf) is a number of CRC bits corresponding to
![](./media/image707.wmf) UCI bits, and ![](./media/image708.wmf) is a
number of CRC bits corresponding to ![](./media/image709.wmf) UCI bits.
...
from the ![](./media/image713.wmf) PRBs satisfying
![](./media/image714.wmf) as described in clauses 9.2.3 and 9.2.5.1
...
transmission together with the HARQ-ACK, SR and
![](./media/image664.wmf) Part 1 CSI reports , where
![](./media/image719.wmf) is the number of Part 1 CSI report bits for
the ![](./media/image720.wmf) CSI report and ![](./media/image721.wmf)
is the number of Part 2 CSI report bits for the
![](./media/image720.wmf) CSI report priority value,
![](./media/image722.wmf) is a number of CRC bits corresponding to
![](./media/image723.wmf), and ![](./media/image724.wmf) is a number of
CRC bits corresponding to ![](./media/image725.wmf)

\- else, the UE drops all Part 2 CSI reports and selects
![](./media/image726.wmf) Part 1 CSI report(s), from the
![](./media/image664.wmf) CSI reports in ascending priority value \[6,
TS 38.214\], for transmission together with the HARQ-ACK and SR
information bits where the value of ![](./media/image727.wmf) satisfies
...
*betaOffsets = \'dynamic\'*, the UE applies the
![](./media/image737.wmf), ![](./media/image738.wmf), and
![](./media/image739.wmf) values that are determined from the first
value of  *betaOffsets = \'dynamic\'*.
...
![](./media/image742.wmf) for the UE to use if the UE multiplexes up to
2 HARQ-ACK information bits, more than 2 and up to 11 HARQ-ACK
information bits, and more than 11 bits in the PUSCH, respectively.

Part 1 CSI report and Part 2 CSI report offsets
![](./media/image735.wmf) and ![](./media/image736.wmf), respectively,
are configured to values according to Table 9.3-2. The
*betaOffsetCSI-Part1-Index1* and *betaOffsetCSI-Part2-Index1*
respectively provide indexes ![](./media/image743.wmf) and
![](./media/image744.wmf) for the UE to use if the UE multiplexes up to
...
respectively provide indexes ![](./media/image745.wmf) or
![](./media/image746.wmf) for the UE to use if the UE multiplexes more
...
two or four ![](./media/image749.wmf) indexes from Tables 9.3-1 and
...
transmission. The beta\_offset indicator field indicates a
![](./media/image750.wmf) value, a ![](./media/image748.wmf) value and a
![](./media/image749.wmf) value from the respective sets of values, with
the mapping defined in Table 9.3-3 and in Table 9.3-3A.
...
cardinality of ![](./media/image763.wmf) and by
![](./media/image764.wmf) a set of USS sets with cardinality of
![](./media/image765.wmf). The location of USS sets
![](./media/image766.wmf), ![](./media/image767.wmf), in
![](./media/image764.wmf) is according to an ascending order of the
search space set index.

Denote by ![](./media/image768.wmf), ![](./media/image769.wmf), the
number of counted PDCCH candidates for monitoring for CSS set
...
For the CSS sets, a UE monitors ![](./media/image773.wmf) PDCCH
candidates requiring a total of ![](./media/image774.wmf)
...
search space set ![](./media/image776.wmf) and by
![](./media/image777.wmf) the cardinality of ![](./media/image775.wmf)
where the non-overlapping CCEs for search space set
![](./media/image776.wmf) are determined considering the allocated PDCCH
candidates for monitoring for the CSS sets and the allocated PDCCH
candidates for monitoring for all search space sets
...
allocate ![](./media/image785.wmf) PDCCH candidates for monitoring to
USS set ![](./media/image786.wmf)
...
\- a number of slots ![](./media/image792.wmf) with only downlink
symbols by *nrofDownlinkSlots*

\- a number of downlink symbols ![](./media/image793.wmf) by
*nrofDownlinkSymbols*

\- a number of slots ![](./media/image794.wmf) with only uplink symbols
by *nrofUplinkSlots*
...
![](./media/image797.wmf). A value ![](./media/image798.wmf) msec is
valid only for ![](./media/image799.wmf) or ![](./media/image800.wmf). A
value ![](./media/image801.wmf) msec is valid only for
![](./media/image802.wmf), or ![](./media/image803.wmf), or
![](./media/image804.wmf).

A slot configuration period of ![](./media/image791.wmf) msec includes
![](./media/image805.wmf) slots with SCS configuration
![](./media/image806.wmf). From the ![](./media/image807.wmf) slots, a
first ![](./media/image808.wmf) slots include only downlink symbols and
a last ![](./media/image794.wmf) slots include only uplink symbols. The
![](./media/image809.wmf) symbols after the first
![](./media/image808.wmf) slots are downlink symbols. The
![](./media/image795.wmf) symbols before the last
![](./media/image794.wmf) slots are uplink symbols. The remaining
![](./media/image810.wmf) are flexible symbols.

The first symbol every ![](./media/image811.wmf) periods is a first
...
\- a number of slots ![](./media/image813.wmf) with only downlink
symbols by *nrofDownlinkSlots*

\- a number of downlink symbols ![](./media/image814.wmf) by
*nrofDownlinkSymbols*

\- a number of slots ![](./media/image815.wmf) with only uplink symbols
by *nrofUplinkSlots*
...
first ![](./media/image819.wmf) slots and second
![](./media/image820.wmf) slots.

From the ![](./media/image821.wmf) slots, a first
![](./media/image822.wmf) slots include only downlink symbols and a last
![](./media/image815.wmf) include only uplink symbols. The
![](./media/image823.wmf) symbols after the first
![](./media/image822.wmf) slots are downlink symbols. The
![](./media/image824.wmf) symbols before the last
![](./media/image815.wmf) slots are uplink symbols. The remaining
![](./media/image825.wmf) are flexible symbols.

A UE expects that ![](./media/image818.wmf) divides 20 msec.

The first symbol every ![](./media/image826.wmf) periods is a first
symbol in an even frame.

A UE expects that the reference SCS configuration
![](./media/image827.wmf) is smaller than or equal to a SCS
configuration ![](./media/image828.wmf) for any configured DL BWP or UL
BWP. Each slot provided by *pattern1* or *pattern2* is applicable to
...
and ![](./media/image832.wmf) symbols before the valid PRACH occasion,
...
![](./media/image836.wmf){width="0.5in"
...
![](./media/image839.wmf) is the PDCCH monitoring periodicity provided
by the value of *monitoringSlotPeriodicityAndOffset,* as described in
clause 10.1, ![](./media/image840.wmf) is the number of symbols per
slot, ![](./media/image841.wmf) is the SCS configuration for a serving
cell with mapping to a respective field in the DCI format 2\_1,
![](./media/image842.wmf) is the SCS configuration of the DL BWP where
the UE receives the PDCCH with the DCI format 2\_1. If the UE is
...
![](./media/image843.wmf) symbols prior to the first symbol of the
CORESET in the slot. The resulting set of symbols includes a number of
symbols that is denoted as ![](./media/image844.wmf).

The UE does not expect to be provided values of
![](./media/image841.wmf), ![](./media/image845.wmf), and
![](./media/image839.wmf) resulting to a value of
![](./media/image846.wmf) that is not an integer. The UE does not expect
to be configured by *monitoringSymbolsWithinSlot* with more than one
PDCCH monitoring occasion for DCI format 2\_1 in a slot.
...
![](./media/image847.wmf) symbol groups includes
![](./media/image848.wmf) symbols, each of the last
![](./media/image849.wmf) symbol groups includes
![](./media/image850.wmf) symbols, a bit value of 0 indicates
...
![](./media/image851.wmf) symbol groups includes
![](./media/image852.wmf) symbols, each of the last
![](./media/image853.wmf) symbol groups includes
...
![](./media/image868.wmf), and a value ![](./media/image869.wmf)
provided by *offsetToCarrier* for the *subcarrierSpacing*
...
as described in Tables 13-11 through 13-15. ![](./media/image870.wmf)
and ![](./media/image871.wmf) are the SFN and slot index within a frame
of the CORESET based on SCS of the CORESET and ![](./media/image872.wmf)
and ![](./media/image873.wmf) are the SFN and slot index based on SCS of
the CORESET, respectively, where the SS/PBCH block with index
![](./media/image874.wmf) overlaps in time with system frame
![](./media/image872.wmf) and slot ![](./media/image875.wmf). The
...
Tables 13-7, 13-8, and 13-10 ![](./media/image876.wmf) is defined in
\[4, TS 38.211\].
...
![](./media/image877.wmf) as ![](./media/image878.wmf) that is in a
frame with system frame number (SFN) ![](./media/image879.wmf)
satisfying ![](./media/image880.wmf) if ![](./media/image881.wmf), or in
a frame with SFN satisfying ![](./media/image882.wmf) if
![](./media/image883.wmf). ![](./media/image884.wmf) and
![](./media/image885.wmf) are provided by Tables 13-11 and 13-12, and
![](./media/image886.wmf) based on the SCS for PDCCH receptions in the
CORESET \[4, TS 38.211\]. The index for the first symbol of the CORESET
in slots ![](./media/image877.wmf) and ![](./media/image887.wmf) is the
first symbol index provided by Tables 13-11 and 13-12.
...
![](./media/image888.wmf) and ![](./media/image889.wmf) based on
...
|           |                           | !                         |
|           | ![](./media/image906.wmf) | [](./media/image908.wmf), |
|           | or                        | !                         |
|           | ![](./media/image907.wmf) | [](./media/image909.wmf), |
|           |                           | !                         |
|           |                           | [](./media/image910.wmf), |
|           |                           | !                         |
|           |                           | [](./media/image911.wmf), |
...
Type0-PDCCH CSS set is not present, and for ![](./media/image920.wmf)
for FR1 or for ![](./media/image921.wmf) for FR2, the UE may determine
...
Type0-PDCCH CSS set is not present, and for ![](./media/image925.wmf)
for FR1 or for ![](./media/image926.wmf) for FR2, the UE determines that
there is no SS/PBCH block having an associated Type0-PDCCH CSS set
within a GSCN range ![](./media/image927.wmf).
![](./media/image928.wmf)and ![](./media/image929.wmf) are respectively
determined by *controlResourceSetZero* and *searchSpaceZero in
pdcch-ConfigSIB1.* If the GSCN range is ![](./media/image930.wmf), the
UE determines that there is no information for a second SS/PBCH block
with a CORESET for an associated Type0-PDCCH CSS set on the detected
SS/PBCH block*.*
...
![](./media/image931.wmf) and *controlResourceSetZero* and
*searchSpaceZero in pdcch-ConfigSIB1* to ![](./media/image932.wmf) for
FR1
