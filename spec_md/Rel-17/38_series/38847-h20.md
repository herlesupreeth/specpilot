...
Conformance testing for the base station requirements is limited by the
...
specified in 38.101-4. For n262, the Noc levels are calculated based on
the reference sensitivity as described in section 4.5.3.3 of TS
38.101-2.
