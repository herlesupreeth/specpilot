...
**absolute position:** absolute position is an estimate of the UE
...
In 3GPP specifications, V2X positioning requirements can be found in TS
...
Uu interface is available for UEs under in-coverage scenario, and also
