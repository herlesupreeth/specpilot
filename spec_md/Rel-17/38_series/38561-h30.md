...
A.4.2.1.1.3 Total combined mismatch uncertainty 46
...
A.4.2.11 Uncertainty related to the use of phantoms 54
...
D.1 Maximum uncertainty of test system 68
...
based on the detailed test parameters for each band, as defined in TR
38.834 \[10\] Table 4.3.3-2.
...
applicable. The measurement should be carried out based on the detailed
test parameters for each band, as defined in TR 38.834 Table 4.3.3-3.
The UL power configuration for LTE and NR is 50%-50% power splitting,
i.e.,
...
integrated to TRP, as defined in Clause 5.1 in TR 38.834 \[10\].
...
The assessment of uncertainties for the Wide Grip hand phantom defined
in CTIA Certification OTA Test Plan 01.72 Section 2.2.13 \[12\], is
further detailed in CTIA Certification OTA Test Plan 01.70 Section 3
\[8\]. Values are from the CTIA Certification Test Plan for Wireless
Device Over-the-Air Performance © CTIA Certification. Reproduced with
permission.
...
method are listed in Table A.4.4.1-1. E*xample uncertainty budget is
...
(browsing mode) measurement for anechoic chamber method for NR FR1 bands
  ...
  **Stage 1: Calibration measurement, network analyzer method**                                                                                                                                                                                                                                                                                                                                  
  13                                                                    Uncertainty of network analyzer                                                     Manufacturer's uncertainty calculator, covers NA setup                                                     0.2                            0.5              Normal        2.00     1                                 0.10             0.25
...
![Diagram Description automatically
generated](./media/image21.png){width="4.159315398075241in"
...
![pdaspacer3](./media/image22.jpeg){width="1.3441557305336833in"
...
2.  The maximum acceptable uncertainty of the Test System is specified
    in Table D.1-1 for each test, where appropriate. The Test System
    ...
    (browsing mode) tests using anechoic chamber method for NR FR1 bands
...
16. Test tolerances in Table D.2-1 are used to relax the Minimum
...
+-------------------------------------------+-------------------------+
| 21. Clause                                | 22. Test Tolerance (TT) |
+===========================================+=========================+
| 18. 6.2.1.1.1 Total Radiated Power (TRP)  | TT = 0.62 x MTSU        |
|     for FR1 NR Standalone (SA) in         |                         |
|     Browsing Mode with Hand Phantom       | 1.02 dB : \< 3 GHz      |
|                                           |                         |
|                                           | **1.07 dB \>= 3 GHz**   |
+-------------------------------------------+-------------------------+
| 19. 7.2.1.1.1 Total Radiated Sensitivity  | TT = 0.62 x MTSU        |
