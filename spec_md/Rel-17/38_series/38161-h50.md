...
\[2\]. A preliminary example uncertainty budget for TRP hand only test
case using Anechoic Chamber test system is presented in Table A.4.2-1.
...
\[2\]. A preliminary *example uncertainty budget* TRS hand only test
case using Anechoic Chamber test system *is presented in Table A.4.2-2.*

Table A.4.2-2: Preliminary example of uncertainty budget for TRS hand
only (browsing mode) measurement for anechoic chamber method for NR FR1
bands
...
which is specified in CTIA Certification OTA Test Plan \[9\].

The Head phantom defined in CTIA Certification OTA Test Plan section C.2
\[9\], is used for FR1 TRP TRS requirement testing.
...
C.4.8 \[9\], is adopted for TRP TRS testing for the UE with width ≥56mm
and ≤72mm.
...
C.4.9 \[9\], is used for FR1 TRP TRS testing for UE with width \>72mm
and ≤92mm.
...
section A.1.4.4 \[9\], is used for FR1 TRP TRS testing for UE with width
\>72mm and ≤92mm.

![](./media/image10.png){width="4.159315398075241in"
...
![pdaspacer3](./media/image11.jpeg){width="1.3441557305336833in"
...
Phantom and Head Phantom are specified in Clause B.3.1.
...
![](./media/image12.wmf){width="2.0833333333333335in"
height="1.5208333333333333in"}

Figure B.3.2.1-1: Reference plane on head phantom, front view

![](./media/image13.wmf){width="1.4013888888888888in"
...
|       |       |       |       |       |       | ction |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RAN   | RP-2  | 0010  |       | A     | CR on | 1     |
| 24-06 | \#104 | 41441 |       |       |       | p     | 7.4.0 |
|       |       |       |       |       |       | relim |       |
|       |       |       |       |       |       | inary |       |
|       |       |       |       |       |       | MU    |       |
|       |       |       |       |       |       | alig  |       |
...
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RAN   |       |       |       |       | MCC   | 1     |
| 24-06 | \#104 |       |       |       |       | edit  | 7.4.1 |
|       |       |       |       |       |       | orial |       |
|       |       |       |       |       |       | u     |       |
|       |       |       |       |       |       | pdate |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RAN   | RP-2  | 0011  |       | F     | Cla   | 1     |
| 24-09 | \#105 | 42198 |       |       |       | rific | 7.5.0 |
|       |       |       |       |       |       | ation |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | vo    |       |
|       |       |       |       |       |       | ltage |       |
...
|       |       |       |       |       |       | ement |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RAN   | RP-2  | 0015  |       | F     | CR to | 1     |
| 24-09 | \#105 | 42164 |       |       |       | R     | 7.5.0 |
|       |       |       |       |       |       | el-17 |       |
|       |       |       |       |       |       | TS    |       |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 8.161 |       |
