...
If the ***UE TEG Information Request*** IE is set to \"periodic\", the
...
If the *Number of TRP RxTx TEGs* IE is included in the *TRP Measurement
Update List* IE in the MEASUREMENT UPDATE message, the NG-RAN node shall
clear any previously stored information and store the newly received
information.
...
This message is sent by the LMF to request the NG-RAN node to configure
or update PRS transmission.
...
This message is sent by the NG-RAN node to acknowledge configuring or
updating the PRS transmission.
...
This message is sent by the NG-RAN node to indicate that it cannot
configure any PRS transmission.
...
This message is sent by the LMF to provide the PRS configuration
information of multiple TRPs to the NG-RAN node and request to configure
measurement gap or PRS processing window of the UE.
...
| ID      |         |       |         |         |         |         |
+---------+---------+-------+---------+---------+---------+---------+
| Pr      | M       |       | BIT     | In      | YES     | ignore  |
| econfig |         |       | STRING  | dicates |         |         |
| uration |         |       | (S      | what    |         |         |
| Result  |         |       | IZE(8)) | has     |         |         |
|         |         |       |         | been    |         |         |
|         |         |       |         | precon  |         |         |
...
This message is sent by the NG-RAN node to indicate that configuration
of measurement gap or PRS processing window of the UE was unsuccessful.
...
This message is sent by the LMF to request the NG-RAN node to activate
or deactivate the preconfigured measurement gap or PRS processing window
for the UE.
...
|         |         |         | \...)   |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| Meas    | **      |         | ENU     | The     | YES     | reject  |
| urement | C-ifRep |         | MERATED | co      |         |         |
| Peri    | ortChar |         | (120ms, | depoint |         |         |
| odicity | acteris |         | 240ms,  | 120ms,  |         |         |
|         | ticsPer |         | 480ms,  | 240ms,  |         |         |
|         | iodic** |         | 640ms,  | 480ms,  |         |         |
|         |         |         | 1024ms, | 1024ms, |         |         |
|         |         |         | 2048ms, | 2048ms, |         |         |
...
|         |         |         |         | \[16\]  |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| SFN     | O       |         | R       | If this | YES     | ignore  |
| initial |         |         | elative | IE is   |         |         |
| isation |         |         | Time    | not     |         |         |
| Time    |         |         | 1900    | p       |         |         |
|         |         |         |         | resent, |         |         |
|         |         |         | 9.2.36  | the TRP |         |         |
...
|         |         |         |         | cluded. |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| System  | O       |         | IN      |         | YES     | ignore  |
| Frame   |         |         | TEGER(0 |         |         |         |
| Number  |         |         | ..1023) |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| Slot    | O       |         | INTEGER |         | YES     | ignore  |
| Number  |         |         | (0..79) |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| Meas    | C-ifMea |         | ENU     |         | YES     | reject  |
| urement | sPerExt |         | MERATED |         |         |         |
| Peri    |         |         | (160ms, |         |         |         |
| odicity |         |         | 320ms,  |         |         |         |
| E       |         |         | 1280ms, |         |         |         |
| xtended |         |         | 2560ms, |         |         |         |
...
This message is sent by the NG-RAN node to report positioning
measurements for the target UE.
...
This message is sent by the LMF to update a previously configured
measurement.
...
|             |          |             |             | procedure.  |
+-------------+----------+-------------+-------------+-------------+
| Procedure   | O        |             | ENUMERATED  | This        |
| Criticality |          |             | (reject,    | Procedure   |
|             |          |             | ignore,     | Criticality |
|             |          |             | notify)     | is used for |
|             |          |             |             | reporting   |
|             |          |             |             | the         |
...
The *NG-RAN Access Point Position* IE is used to identify the
geographical position of an NG-RAN Access Point. It is expressed as
ellipsoid point with altitude and uncertainty ellipsoid according to TS
23.032 \[8\].
...
The purpose of the Other-RAT Measurement Result information element is
to provide the measurement results of RATs other than the serving RAT.
...
The *PRS Muting Configuration EUTRA* IE is used to describe the
configuration of PRS muting patterns for the concerned cell/TP,
according to TS 36.211 \[10\] and TS 36.133 \[9\].
...
|                |          |       |                | string         |
+----------------+----------+-------+----------------+----------------+
| > *\>Four*     |          |       | BIT STRING (4) | **Same as      |
|                |          |       |                | above**        |
+----------------+----------+-------+----------------+----------------+
| > *\>Eight*    |          |       | BIT STRING (8) | **Same as      |
|                |          |       |                | above**        |
+----------------+----------+-------+----------------+----------------+
| > *\>Sixteen*  |          |       | BIT STRING     | **Same as      |
|                |          |       | (16)           | above**        |
+----------------+----------+-------+----------------+----------------+
| >              |          |       | BIT STRING     | **Same as      |
| *\>thirty-two* |          |       | (32)           | above**        |
...
| *\>sixty-four* |          |       | (64)           | above**        |
+----------------+----------+-------+----------------+----------------+
| > *\>o         |          |       | BIT STRING     | **Same as      |
| ne-hundred-and |          |       | (128)          | above**        |
| -twenty-eight* |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| > *            |          |       | BIT STRING     | **Same as      |
| \>two-hundred- |          |       | (256)          | above**        |
| and-fifty-six* |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| >              |          |       | BIT STRING     | **Same as      |
|  *\>five-hundr |          |       | (512)          | above**        |
| ed-and-twelve* |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| > *\>o         |          |       | BIT STRING     | **Same as      |
| ne-thousand-an |          |       | (1024)         | above**        |
| d-twenty-four* |          |       |                |                |
+----------------+----------+-------+----------------+----------------+

### 9.2.17 PRS Frequency Hopping Configuration EUTRA

The *PRS Frequency Hopping Configuration EUTRA* IE is used to describe
the configuration of PRS frequency hopping for the concerned cell/TP,
according to TS 36.211 \[10\].
...
The *TDD Configuration EUTRA* IE is used to specify the TDD specific
...
+-------------+----------+-------------+-------------+-------------+
| >           |          | *1..\<      |             | Corresponds |
|  **\>System |          | maxNrOfPosS |             | to the      |
| > In        |          | Imessage\>* |             | number of   |
| formation** |          |             |             | SI messages |
|             |          |             |             | with        |
|             |          |             |             | posSIBs to  |
|             |          |             |             | be          |
|             |          |             |             | scheduled   |
+-------------+----------+-------------+-------------+-------------+
| > \>        | M        |             | ENUMERATED  | Corresponds |
| \>Broadcast |          |             | (ms80,      | to          |
| >           |          |             | ms160,      | information |
| Periodicity |          |             | ms320,      | provided in |
|             |          |             | ms640,      | *posSI-P    |
|             |          |             | ms1280,     | eriodicity* |
|             |          |             | ms2560,     | contained   |
|             |          |             | ms5120,     | in the      |
...
This parameter identifies the assistance information for which the
NG-RAN Node failed to configure broadcasting.
...
+-------------+----------+-------------+-------------+-------------+
| *           |          | *1..\<m     |             |             |
| *Assistance |          | axnoAssistI |             |             |
| Information |          | nfoFailureL |             |             |
| Failure     |          | istItems\>* |             |             |
| List**      |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| > \>        | M        |             | 9.2.22      |             |
...
The *TRP ID* IE is used to identify a TRP uniquely within an NG-RAN
node.
...
The *TRP Information* IE contains information for one TRP within an
NG-RAN node.
...
|                |          |       | Reference      | Description    |
+----------------+----------+-------+----------------+----------------+
| Expected       | M        |       | INTEGER        | **Indicates    |
| Propagation    |          |       |                | when the SRS   |
| Delay          |          |       | (-3            | is expected to |
|                |          |       | 841..3841,...) | arrive in time |
|                |          |       |                | at the TRP     |
|                |          |       |                | relative to    |
|                |          |       |                | the UL RTOA    |
|                |          |       |                | Reference      |
...
|                |          |       |                | search window. |
+----------------+----------+-------+----------------+----------------+
| Delay          | M        |       | INTEGER        | **Indicates    |
| Uncertainty    |          |       |                | the            |
|                |          |       | (1..246,...)   | uncertainty of |
|                |          |       |                | the expected   |
|                |          |       |                | SRS arrival    |
|                |          |       |                | time at the    |
|                |          |       |                | TRP**          |
...
This information element contains the SRS configuration configured by
the NG-RAN node for the UE.
...
| >           |          | *0..\<      |             |             |
|  **\>\>\>\> |          | ma          |             |             |
| Positioning |          | xnoSRS-PosR |             |             |
| > SRS       |          | esources\>* |             |             |
| > Resource  |          |             |             |             |
| > List**    |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| >           | M        |             | 9.2.30      | Corresponds |
|  \>\>\>\>\> |          |             |             | to          |
...
| >           |          | *0..\<maxno |             |             |
|  **\>\>\>\> |          | SRS-PosReso |             |             |
| Positioning |          | urceSets\>* |             |             |
| > SRS       |          |             |             |             |
| > Resource  |          |             |             |             |
| > Set       |          |             |             |             |
| > List**    |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| >           | M        |             | 9.2.32      | Corresponds |
|  \>\>\>\>\> |          |             |             | to          |
| Positioning |          |             |             | information |
| > SRS       |          |             |             | provided in |
| > Resource  |          |             |             | *SRS-PosR   |
...
|             |          |             |             | \[13\]      |
+-------------+----------+-------------+-------------+-------------+
| > \>\>NR    | O        |             | INTEGER     | Physical    |
| > PCI       |          |             | (0..1007)   | Cell ID of  |
|             |          |             |             | the cell    |
|             |          |             |             | that        |
|             |          |             |             | contains    |
|             |          |             |             | the SRS     |
...
| osition |         |       |         |         |         |         |
+---------+---------+-------+---------+---------+---------+---------+
| Number  | M       |       | ENUMER  | **This  | \-      |         |
| of      |         |       | ATED(n1 | IE is   |         |         |
| Symbols |         |       | ,n2,n4) | ignored |         |         |
|         |         |       |         | if the  |         |         |
|         |         |       |         | *Number |         |         |
|         |         |       |         | of      |         |         |
|         |         |       |         | S       |         |         |
...
+---------+---------+-------+---------+---------+---------+---------+
| Rep     | M       |       | ENUMER  | **This  | \-      |         |
| etition |         |       | ATED(r1 | IE is   |         |         |
| Factor  |         |       | ,r2,r4) | ignored |         |         |
|         |         |       |         | if the  |         |         |
|         |         |       |         | *Rep    |         |         |
|         |         |       |         | etition |         |         |
|         |         |       |         | Factor* |         |         |
...
| > Offset       |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| > \>\>Cyclic   | M        |       | INTEGER(0..5)  |                |
| > Shift        |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| Start Position | M        |       | INTEGER(0..13) |                |
+----------------+----------+-------+----------------+----------------+
| Number of      | M        |       | ENUMER         |                |
| Symbols        |          |       | ATED(n1,n2,n4, |                |
|                |          |       | n8, n12}       |                |
+----------------+----------+-------+----------------+----------------+
| Frequency      | M        |       | I              |                |
| Domain Shift   |          |       | NTEGER(0..268) |                |
+----------------+----------+-------+----------------+----------------+
| C-SRS          | M        |       | INTEGER(0..63) |                |
+----------------+----------+-------+----------------+----------------+
| Group or       | M        |       | ENUME          |                |
| Sequence       |          |       | RATED(Neither, |                |
...
This information element indicates an SRS resource set in the UE for UL
SRS transmission.
...
| > Trigger   |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| > \>\>Slot  | M        |             | INT         | **Offset in |
| > offset    |          |             | EGER(0..32) | number of   |
|             |          |             |             | slots,      |
|             |          |             |             | where value |
|             |          |             |             | 0 indicates |
|             |          |             |             | no          |
...
This information element indicates a positioning SRS resource set in the
UE for UL SRS transmission.
...
| Positioning |          | .\<*maxnoSR |             |             |
| SRS         |          | S-PosResour |             |             |
| Resource ID |          | cePerSet*\> |             |             |
| List**      |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| > \>        | M        |             | INT         |             |
| Positioning |          |             | EGER(0..63) |             |
| > SRS       |          |             |             |             |
| > Resource  |          |             |             |             |
| > ID        |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
...
This information element indicates a spatial relation for transmission
of UL SRS by a UE.
...
| Name        |          |             | Reference   | Description |
+-------------+----------+-------------+-------------+-------------+
| **Spatial   |          | *1..\<ma    |             | According   |
| Relation    |          | xnoSpatialR |             | to TS       |
| for         |          | elations\>* |             | 38.321      |
| Resource    |          |             |             | \[15\] and  |
| ID**        |          |             |             | corresponds |
|             |          |             |             | to          |
...
| Name        |          |             | Reference   | Description |
+-------------+----------+-------------+-------------+-------------+
| **Aperiodic |          | *1..\<max   |             | Corresponds |
| SRS         |          | noSRS-Trigg |             | to          |
| Resource    |          | erStates\>* |             | information |
| Trigger     |          |             |             | provided in |
| List**      |          |             |             | a           |
|             |          |             |             | *periodicSR |
|             |          |             |             | S-ResourceT |
...
| rmation |         |         |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| > \>SRS | O       |         | 9.2.73  |         | YES     | ignore  |
| > R     |         |         |         |         |         |         |
| esource |         |         |         |         |         |         |
| > type  |         |         |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| > \>ARP | O       |         | 9.2.75  |         | YES     | ignore  |
| > ID    |         |         |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| > \>L   | O       |         | 9.2.77  |         | YES     | ignore  |
| oS/NLoS |         |         |         |         |         |         |
| > Info  |         |         |         |         |         |         |
| rmation |         |         |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
...
This information element contains the uplink Angle of Arrival
measurement.
...
This information element contains the gNB Rx-Tx Time Difference
measurement.
...
This information element contains the TRP's best estimate of the quality
of the measurement.
...
+-------------+----------+-------------+-------------+-------------+
| > \>\>PRS   | M        |             | INT         | 24          |
| > bandwidth |          |             | EGER(1..63) | ,28,...,272 |
|             |          |             |             | PRBs        |
+-------------+----------+-------------+-------------+-------------+
| > \>\>Start | M        |             | INTEG       | Starting    |
| > PRB       |          |             | ER(0..2176) | PRB to      |
|             |          |             |             | Point A     |
+-------------+----------+-------------+-------------+-------------+
| > \>\>Point | M        |             | INTEGER     | **NR        |
| > A         |          |             | (           | ARFCN**     |
...
+-------------+----------+-------------+-------------+-------------+
| > \         | M        |             | ENUME       | **Slots**   |
| >\>Resource |          |             | RATED(4,5,8 |             |
| > Set       |          |             | ,10,16,20,3 |             |
| >           |          |             | 2,40,64,80, |             |
| Periodicity |          |             | 160,320,640 |             |
|             |          |             | ,1280,2560, |             |
|             |          |             | 5120,10240, |             |
|             |          |             | 20480,40960 |             |
|             |          |             | ,81920,..., |             |
...
+-------------+----------+-------------+-------------+-------------+
| > \         | M        |             | E           |             |
| >\>Resource |          |             | NUMERATED(r |             |
| >           |          |             | f1,rf2,rf4, |             |
|  Repetition |          |             | rf6,rf8,rf1 |             |
| > Factor    |          |             | 6,rf32,...) |             |
+-------------+----------+-------------+-------------+-------------+
| > \         | M        |             | ENUMERAT    |             |
| >\>Resource |          |             | ED(tg1,tg2, |             |
| > Time Gap  |          |             | tg4,tg8,tg1 |             |
|             |          |             | 6,tg32,...) |             |
+-------------+----------+-------------+-------------+-------------+
| > \         | M        |             | ENUMER      |             |
| >\>Resource |          |             | ATED(n2,n4, |             |
...
+-------------+----------+-------------+-------------+-------------+
| > \>\       | M        |             | DL-PRS      | **Muting    |
| >\>\>Muting |          |             | Muting      | pattern     |
| > Pattern   |          |             | Pattern     | option 1 is |
|             |          |             |             | used to     |
|             |          |             | 9.2.56      | mute the    |
|             |          |             |             | whole PRS   |
|             |          |             |             | resource    |
...
This information element contains the spatial direction information of
the DL PRS resources for the TRP.
...
This information element contains the geographical coordinates for the
TRP and any associated ARP(s).
...
This information element contains the geographical coordinates of the
antenna reference points (ARP) for the DL-PRS Resources of a TRP.
...
This information element provides a location relative to some known
reference location in a relative geodetic coordinate system. Corresponds
to information provided in *RelativeLocation* IE as defined in TS 37.355
\[14\].
...
|                |          |       | Reference      | Description    |
+================+==========+=======+================+================+
| Mi             | M        |       | ENUMERATED     | **Units and    |
| lli-Arc-Second |          |       | (0.03, 0.3, 3, | scale factor   |
| Units          |          |       | \...)          | for the        |
|                |          |       |                | delta-latitude |
|                |          |       |                | and            |
|                |          |       |                | d              |
...
|                |          |       |                | lliarcseconds. |
+----------------+----------+-------+----------------+----------------+
| Height Units   | M        |       | ENUMERATED     | Units and      |
|                |          |       | (mm, cm, m,    | scale factor   |
|                |          |       | \...)          | for the        |
|                |          |       |                | delta-height   |
|                |          |       |                | field.         |
|                |          |       |                |                |
...
|                |          |       |                | 10-2 metre.    |
+----------------+----------+-------+----------------+----------------+
| **Delta        | M        |       | INTEGER        | **Delta value  |
| Latitude**     |          |       | (-1024..1023)  | in latitude in |
|                |          |       |                | the unit       |
|                |          |       |                | provided in**  |
|                |          |       |                | Mi             |
|                |          |       |                | lli-Arc-Second |
...
+----------------+----------+-------+----------------+----------------+
| **Delta        | M        |       | INTEGER        | **Delta value  |
| Longitude**    |          |       | (-1024..1023)  | in longitude   |
|                |          |       |                | in the unit    |
|                |          |       |                | provided in**  |
|                |          |       |                | Mi             |
|                |          |       |                | lli-Arc-Second |
...
+----------------+----------+-------+----------------+----------------+
| **Delta        | M        |       | INTEGER        | **Delta value  |
| Height**       |          |       | (-1024..1023)  | in ellipsoidal |
|                |          |       |                | height in the  |
|                |          |       |                | unit provided  |
|                |          |       |                | in** Height    |
|                |          |       |                | Units.         |
...
The *NG-RAN High Accuracy Access Point Position* IE is used to identify
the geographical position of an NG-RAN Access Point. It is expressed as
High Accuracy Ellipsoid point with altitude and uncertainty ellipsoid
according to TS 23.032 \[8\].
...
This information element provides a location relative to some known
reference location in a relative Cartesian coordinate system.
...
|                |          |       | dm,..)         |                |
+----------------+----------+-------+----------------+----------------+
| X value        | M        |       | INTEGER        | Positive value |
|                |          |       |                | represents     |
|                |          |       | (-2^16^..      | easting from   |
|                |          |       | 2^16^-1)       | reference      |
|                |          |       |                | point, in      |
...
|                |          |       |                | Unit* IE.      |
+----------------+----------+-------+----------------+----------------+
| Y value        | M        |       | INTEGER        | Positive value |
|                |          |       |                | represents     |
|                |          |       | (-2^16^..      | northing from  |
|                |          |       | 2^16^-1)       | reference      |
|                |          |       |                | point in units |
...
|                |          |       |                | IE.            |
+----------------+----------+-------+----------------+----------------+
| Z value        | M        |       | INTEGER        | Height with    |
|                |          |       |                | respect to     |
|                |          |       | (-2^15^..      | reference      |
|                |          |       | 2^15^-1)       | point in units |
|                |          |       |                | of *XYZ Unit*  |
|                |          |       |                | IE, where the  |
|                |          |       |                | XY-plane is    |
|                |          |       |                | horizontal and |
...
| > ID*          |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| >              | M        |       | INTEGER(0..    | Referential ID |
| \>\>Coordinate |          |       | 2^9^-1,..)     | mapped via OAM |
| > ID           |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| > *\>Reference |          |       |                |                |
| > Point        |          |       |                |                |
...
This information element indicates a pathloss reference for transmission
of UL SRS by a UE.
...
This information element contains the SSB time/frequency information for
the TRPs.
...
This information element contains the time and frequency configuration
of an SSB.
...
|                |          |       | (0..3279165)   |                |
+----------------+----------+-------+----------------+----------------+
| SSB subcarrier | M        |       | ENU            | **The value**  |
| spacing        |          |       | MERATED(15kHz, | 60kHz is not   |
|                |          |       | 30kHz, 60kHz,  | supported in   |
|                |          |       | 120kHz,        | this version   |
|                |          |       | 240kHz,\... ,  | of the         |
|                |          |       | kHz480,        | specification. |
|                |          |       | kHz960)        |                |
+----------------+----------+-------+----------------+----------------+
| SSB Transmit   | M        |       | INTEGER        | **EPRE of      |
| power          |          |       | (-60..50)      | SSS**          |
+----------------+----------+-------+----------------+----------------+
| SSB            | M        |       | E              |                |
| periodicity    |          |       | NUMERATED(5ms, |                |
|                |          |       | 10ms, 20ms,    |                |
|                |          |       | 40ms, 80ms,    |                |
|                |          |       | 160ms, ...)    |                |
+----------------+----------+-------+----------------+----------------+
| SSB half frame | M        |       | INTEGER(0..1)  |                |
| index          |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
...
This IE is used to indicate the cells that are requested to broadcast,
or failed to broadcast, the associated posSIB(s).
...
This information element indicates a spatial relation for transmission
of each UL SRS resource recommended by LMF.
...
This IE contains the requested PRS configuration for transmission by the
LMF.
...
| > List      |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| > \         | O        |             | Start Time  | **This IE   |
| >\>Resource |          |             | and         | is ignored  |
| > Set Start |          |             | Duration    | if the      |
| > Time and  |          |             |             | *Start Time |
| > Duration  |          |             | 9.2.63      | and         |
|             |          |             |             | Duration*   |
|             |          |             |             | IE is       |
...
This IE contains the start time and/or duration for the on-demand
DL-PRS.
...
This IE contains the information to turn off particular PRS
transmissions.
...
|                |          |       | Reference      | Description    |
+================+==========+=======+================+================+
| On-demand PRS  | M        |       | BIT STRING     | **Each         |
| Request        |          |       | (SIZE(16))     | position in    |
| Allowed        |          |       |                | the bitmap     |
|                |          |       |                | represents an  |
|                |          |       |                | on-demand PRS  |
|                |          |       |                | transmission   |
...
|                |          |       |                | allowed'.**    |
+----------------+----------+-------+----------------+----------------+
| Allowed        | O        |       | BIT STRING     | **This IE      |
| Resource Set   |          |       | (SIZE(24))     | applies only   |
| Periodicity    |          |       |                | if the first   |
| Values         |          |       |                | bit of the     |
|                |          |       |                | On-demand PRS  |
|                |          |       |                | Request        |
|                |          |       |                | Allowed IE is  |
...
|                |          |       |                | requested.**   |
+----------------+----------+-------+----------------+----------------+
| Allowed PRS    | O        |       | BIT STRING     | **This IE      |
| Bandwidth      |          |       | (SIZE(64))     | applies only   |
| Values         |          |       |                | if the second  |
|                |          |       |                | bit of the     |
|                |          |       |                | On-demand PRS  |
|                |          |       |                | Request        |
|                |          |       |                | Allowed IE is  |
...
+----------------+----------+-------+----------------+----------------+
| Allowed        | O        |       | BIT STRING     | **This IE      |
| Resource       |          |       | (SIZE(8))      | applies only   |
| Repetition     |          |       |                | if the third   |
| Factor Values  |          |       |                | bit of the     |
|                |          |       |                | On-demand PRS  |
|                |          |       |                | Request        |
|                |          |       |                | Allowed IE is  |
|                |          |       |                | set to '1'.**  |
...
| Allowed        | O        |       | BIT STRING     | **This IE      |
| Resource       |          |       | (SIZE(8))      | applies only   |
| Number of      |          |       |                | if the fourth  |
| Symbols Values |          |       |                | bit of the     |
|                |          |       |                | On-demand PRS  |
|                |          |       |                | Request        |
|                |          |       |                | Allowed IE is  |
|                |          |       |                | set to '1'.**  |
...
|                |          |       |                | requested.**   |
+----------------+----------+-------+----------------+----------------+
| Allowed Comb   | O        |       | BIT STRING     | **This IE      |
| Size Values    |          |       | (SIZE(8))      | applies only   |
|                |          |       |                | if the fifth   |
|                |          |       |                | bit of the     |
|                |          |       |                | On-demand PRS  |
|                |          |       |                | Request        |
...
This information element contains the expected uplink Angle of Arrival
...
+---------------+----------+--------+---------------+---------------+
| > \           | M        |        | INT           | φ~AOA~        |
| >\>\>Expected |          |        | EGER(0..3599) | component of  |
| > Azimuth AoA |          |        |               | Expected      |
| > Value       |          |        |               | Azimuth AoA   |
+---------------+----------+--------+---------------+---------------+
| > \           | M        |        | INT           | Δφ~AOA~       |
| >\>\>Expected |          |        | EGER(0..3599) | component of  |
| > Azimuth AoA |          |        |               | Expected      |
| > Uncertainty |          |        |               | Azimuth AoA   |
| > Range       |          |        |               |               |
+---------------+----------+--------+---------------+---------------+
| > *           |          | *0..1* |               | Defined as    |
| *\>\>Expected |          |        |               |               |
...
+---------------+----------+--------+---------------+---------------+
| > \           | M        |        | INT           | θ~ZOA~        |
| >\>\>Expected |          |        | EGER(0..1799) | component of  |
| > Zenith AoA  |          |        |               | Expected      |
| > Value       |          |        |               | Zenith AoA    |
+---------------+----------+--------+---------------+---------------+
| > \           | M        |        | INT           | Δθ~ZOA~       |
...
| > Range       |          |        |               |               |
+---------------+----------+--------+---------------+---------------+
| LCS to GCS    | O        |        | 9.2.69        | If absent,    |
| Translation   |          |        |               | the azimuth   |
|               |          |        |               | and zenith    |
|               |          |        |               | are provided  |
|               |          |        |               | in GCS. In    |
|               |          |        |               | case of       |
...
This information element contains the Zenith Angle of Arrival
information, which can correspond to linear array measurement.
...
This information element contains the response time of the measurement
results reporting.
...
This information element contains the LCS to GCS Translation
information.
...
This information element contains the list of the multiple UL-AOAs
values.
...
This IE contains the extended additional path results of time
measurement.
...
| > Indicator*   |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| > \>\>LoS/NLoS | M        |       | INTEGER        | Values provide |
| > Indicator    |          |       | (0..10)        | the likelihood |
| > Soft         |          |       |                | of a LOS       |
|                |          |       |                | propagation    |
|                |          |       |                | path in the    |
|                |          |       |                | range between  |
...
| Carrier |         |         |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| > \>UE  | O       |         | Timing  | Timing  | YES     | ignore  |
| > Tx    |         |         | Error   | error   |         |         |
| >       |         |         | Margin  | margin  |         |         |
|  Timing |         |         |         | ass     |         |         |
| > Error |         |         | 9.2.84  | ociated |         |         |
| >       |         |         |         | to the  |         |         |
|  Margin |         |         |         | UE Tx   |         |         |
|         |         |         |         | TEG ID. |         |         |
+---------+---------+---------+---------+---------+---------+---------+
...
This IE contains the measurement characteristic information requested by
LMF.
...
|                |          |       | Reference      | Description    |
+================+==========+=======+================+================+
| Measurement    | M        |       | BIT STRING     | **Each         |
| characteristic |          |       | (SIZE(16))     | position in    |
| request        |          |       |                | the bitmap     |
...
The IE provides the beam antenna information of the TRP. It includes
either the explicit beam antenna information, or a reference to another
TRP's signalled configuration, or the indication that no change has
occurred with respect to previously signalled configuration.
...
+----------------+----------+-------+----------------+----------------+
| >              | M        |       | TRP ID         | This IE        |
| \>\>Associated |          |       |                | specifies the  |
| > TRP ID       |          |       | 9.2.24         | *TRP ID* of    |
|                |          |       |                | the associated |
|                |          |       |                | TRP from which |
|                |          |       |                | the beam       |
|                |          |       |                | information    |
...
| > Angles       |          |       |                |                |
+----------------+----------+-------+----------------+----------------+
| > \>\>LCS to   | O        |       | 9.2.69         | Included if    |
| > GCS          |          |       |                | the azimuth    |
| > Translation  |          |       |                | and elevation  |
|                |          |       |                | are not        |
|                |          |       |                | provided in    |
|                |          |       |                | GCS.           |
+----------------+----------+-------+----------------+----------------+
...
| Item**      |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| > \>TRP     | M        |             | INTEGER     | For GCS,    |
| > Azimuth   |          |             | (0..359)    | the azimuth |
| > Angle     |          |             |             | angle is    |
|             |          |             |             | measured    |
|             |          |             |             | counte      |
|             |          |             |             | r-clockwise |
...
This information element contains the Timing error margin for the UE Tx
TEG, TRP Rx TEG, or TRP Tx TEG.
...
This information element contains the TRP Rx TEG information.
  ...
  TRP Rx Timing Error Margin   M                  Timing Error Margin\    Timing error margin associated to the TRP Rx TEG ID.
                                                  9.2.84                  
  ---------------------------- ---------- ------- ----------------------- ------------------------------------------------------
...
This information element contains the TRP Tx TEG information.
  ...
  TRP Tx Timing Error Margin   M                  Timing Error Margin\    Timing error margin associated to the TRP Tx TEG ID.
                                                  9.2.84                  
  ---------------------------- ---------- ------- ----------------------- ------------------------------------------------------
...
Sub clause 9.3 presents the Abstract Syntax of the NRPPa protocol with
...
The ASN.1 definition specifies the structure and content of NRPPa
messages. NRPPa messages can contain any IEs specified in the object set
...
sending entity shall construct an NRPPa message according to the PDU
...
If an NRPPa message that is not constructed as defined above is
...
ngran-access (22) modules (3) nrppa (4) version1 (1)
nrppa-PDU-Descriptions (0) }
...
procedureCode NRPPA-ELEMENTARY-PROCEDURE.&procedureCode
({NRPPA-ELEMENTARY-PROCEDURES}),

criticality NRPPA-ELEMENTARY-PROCEDURE.&criticality
({NRPPA-ELEMENTARY-PROCEDURES}{\@procedureCode}),

nrppatransactionID NRPPATransactionID,

value NRPPA-ELEMENTARY-PROCEDURE.&InitiatingMessage
({NRPPA-ELEMENTARY-PROCEDURES}{\@procedureCode})
...
value NRPPA-ELEMENTARY-PROCEDURE.&SuccessfulOutcome
({NRPPA-ELEMENTARY-PROCEDURES}{\@procedureCode})
...
value NRPPA-ELEMENTARY-PROCEDURE.&UnsuccessfulOutcome
({NRPPA-ELEMENTARY-PROCEDURES}{\@procedureCode})
...
ngran-access (22) modules (3) nrppa (4) version1 (1) nrppa-PDU-Contents
(1) }
...
\-- The IE shall be present if the Report Characteritics IE is set to
"periodic" and the MeasurementQuantities-Item IE in the
...
ProtocolIE-Single-Container { { OTDOA-Information-Type-ItemIEs} }
...
{ ID id-UEReportingInformation CRITICALITY ignore TYPE
UEReportingInformation PRESENCE optional }\|

{ ID id-UE-TEG-Info-Request CRITICALITY ignore TYPE UE-TEG-Info-Request
PRESENCE optional }\|

{ ID id-UE-TEG-ReportingPeriodicity CRITICALITY reject TYPE
UE-TEG-ReportingPeriodicity PRESENCE conditional },

\-- The IE shall be present if the UE TEG Info Request IE is set to
"periodic"
...
{ ID id-SRSConfiguration CRITICALITY ignore TYPE SRSConfiguration
PRESENCE optional}\|
...
{ ID id-UETxTEGAssociationList CRITICALITY ignore TYPE
UETxTEGAssociationList PRESENCE optional},
...
{ ID id-SRSTransmissionStatus CRITICALITY ignore TYPE
SRSTransmissionStatus PRESENCE optional},
...
{ ID id-LMF-Measurement-ID CRITICALITY reject TYPE Measurement-ID
PRESENCE mandatory}\|

{ ID id-TRP-MeasurementRequestList CRITICALITY reject TYPE
...
{ ID id-SystemFrameNumber CRITICALITY ignore TYPE SystemFrameNumber
PRESENCE optional}\|

{ ID id-SlotNumber CRITICALITY ignore TYPE SlotNumber PRESENCE
optional}\|

{ ID id-MeasurementPeriodicityExtended CRITICALITY reject TYPE
MeasurementPeriodicityExtended PRESENCE conditional}\|

\-- The IE shall be present the MeasurementPeriodicity IE is set to the
value \"extended\"

{ ID id-ResponseTime CRITICALITY ignore TYPE ResponseTime PRESENCE
optional}\|

{ ID id-MeasurementCharacteristicsRequestIndicator CRITICALITY ignore
TYPE MeasurementCharacteristicsRequestIndicator PRESENCE optional}\|

{ ID id-MeasurementTimeOccasion CRITICALITY ignore TYPE
MeasurementTimeOccasion PRESENCE optional}\|

{ ID id-MeasurementAmount CRITICALITY ignore TYPE MeasurementAmount
PRESENCE optional},
...
{ ID id-RAN-Measurement-ID CRITICALITY reject TYPE Measurement-ID
PRESENCE mandatory}\|

{ ID id-TRP-MeasurementResponseList CRITICALITY reject TYPE
TRP-MeasurementResponseList PRESENCE optional}\|
...
{ ID id-TRP-MeasurementReportList CRITICALITY reject TYPE
TRP-MeasurementResponseList PRESENCE mandatory},
...
{ ID id-TRP-MeasurementUpdateList CRITICALITY reject TYPE
...
{ ID id-SRSSpatialRelation CRITICALITY ignore EXTENSION
SpatialRelationInfo PRESENCE optional}\|
...
iE-Extensions ProtocolExtensionContainer { {AperiodicSRS-ExtIEs} }
OPTIONAL,
...
{ ID id-AbortTransmission CRITICALITY ignore TYPE AbortTransmission
PRESENCE mandatory } ,
...
{ ID id-PRSConfigRequestType CRITICALITY reject TYPE
PRSConfigRequestType PRESENCE mandatory}\|

{ ID id-PRSTRPList CRITICALITY ignore TYPE PRSTRPList PRESENCE
mandatory},
...
{ ID id-PRSTransmissionTRPList CRITICALITY ignore TYPE
...
{ ID id-TRP-PRS-Information-List CRITICALITY ignore TYPE
TRP-PRS-Information-List PRESENCE mandatory},
...
{ ID id-PreconfigurationResult CRITICALITY ignore TYPE
PreconfigurationResult PRESENCE mandatory }\|
...
{ ID id-RequestType CRITICALITY reject TYPE RequestType PRESENCE
mandatory}\|

{ ID id-PRS-Measurements-Info-List CRITICALITY ignore TYPE
PRS-Measurements-Info-List PRESENCE optional},
...
iE-Extensions ProtocolExtensionContainer { { ActiveULBWP-ExtIEs} }
OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
AdditionalPathListItem-ExtIEs} } OPTIONAL,
...
{ ID id-MultipleULAoA CRITICALITY ignore EXTENSION MultipleULAoA
PRESENCE optional}\|
...
ExtendedAdditionalPathList ::= SEQUENCE (SIZE (1.. maxNoPathExtended))
...
iE-Extensions ProtocolExtensionContainer { {
ExtendedAdditionalPathList-Item-ExtIEs} } OPTIONAL,
...
AperiodicSRSResourceTriggerList ::= SEQUENCE
(SIZE(1..maxnoSRSTriggerStates)) OF AperiodicSRSResourceTrigger
...
iE-Extensions ProtocolExtensionContainer { {
ARPLocationInformation-ExtIEs} } OPTIONAL,
...
mHz15, mHz25, mHz30, mHz60, mHz35, mHz45, mHz70, mHz90},

fR2 ENUMERATED {mHz50, mHz100, mHz200, mHz400, \..., mhz800, mHz1600,
mHz2000 },
...
PositioningBroadcastCells ::= SEQUENCE (SIZE (1..maxnoBcastCell)) OF
NG-RAN-CGI
...
iE-Extensions ProtocolExtensionContainer { {CarrierFreq-ExtIEs} }
OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {CGI-EUTRA-ExtIEs} }
OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
DLPRSResourceCoordinates-ExtIEs } } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
E-CID-MeasurementResult-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
GeographicalCoordinates-ExtIEs } } OPTIONAL,
...
{ ID id-ARPLocationInfo CRITICALITY ignore EXTENSION
...
iE-Extensions ProtocolExtensionContainer { {
LCS-to-GCS-Translation-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
LCS-to-GCS-TranslationItem-ExtIEs} } OPTIONAL,
...
MeasurementAmount ::= ENUMERATED {ma0, ma1, ma2, ma4, ma8, ma16, ma32,
ma64}
...
{ ID id-ResultSS-RSRP CRITICALITY ignore TYPE ResultSS-RSRP PRESENCE
mandatory }\|

{ ID id-ResultSS-RSRQ CRITICALITY ignore TYPE ResultSS-RSRQ PRESENCE
mandatory }\|
...
{ ID id-AngleOfArrivalNR CRITICALITY ignore TYPE UL-AoA PRESENCE
mandatory }\|
...
iE-Extensions ProtocolExtensionContainer { { MultipleULAoA-ExtIEs} }
OPTIONAL,
...
MultipleULAoA-List ::= SEQUENCE (SIZE(1.. maxnoofULAoAs)) OF
MultipleULAoA-Item
...
iE-Extensions ProtocolExtensionContainer { {
NG-RANAccessPointPosition-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {NG-RAN-CGI-ExtIEs} }
OPTIONAL,
...
nR-PRS-Beam-InformationList SEQUENCE (SIZE(1.. maxPRS-ResourceSets)) OF
NR-PRS-Beam-InformationItem,

lCS-to-GCS-TranslationList SEQUENCE (SIZE(1..maxnolcs-gcs-translation))
OF LCS-to-GCS-TranslationItem OPTIONAL,

iE-Extensions ProtocolExtensionContainer { {
NR-PRS-Beam-Information-IEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
NR-PRS-Beam-InformationItem-ExtIEs} } OPTIONAL,
...
{ ID id-TDD-Config-EUTRA-Item CRITICALITY ignore TYPE
TDD-Config-EUTRA-Item PRESENCE mandatory }\|
...
{ ID id-ResultEUTRA CRITICALITY ignore TYPE ResultEUTRA PRESENCE
mandatory },
...
iE-Extensions ProtocolExtensionContainer { {
PathlossReferenceInformation-ExtIEs } } OPTIONAL,
...
PeriodicityItem ::= ENUMERATED {ms0dot125, ms0dot25, ms0dot5, ms0dot625,
ms1, ms1dot25, ms2, ms2dot5, ms4dot, ms5, ms8, ms10, ms16, ms20, ms32,
ms40, ms64, ms80m, ms160, ms320, ms640m, ms1280, ms2560, ms5120,
ms10240, \...}
...
PosSRSResourceSet-List ::= SEQUENCE (SIZE (1..maxnoSRS-PosResourceSets))
OF PosSRSResourceSet-Item

PosSRSResourceIDPerSet-List ::= SEQUENCE (SIZE
(1..maxnoSRS-PosResourcePerSet)) OF SRSPosResourceID
...
iE-Extensions ProtocolExtensionContainer { {
PosSRSResourceSet-Item-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
PosResourceSetTypePeriodic-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
PosResourceSetTypeSemi-persistent-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
PosResourceSetTypeAperiodic-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { { PRSAngleItem-ExtIEs} }
OPTIONAL,
...
{ ID id-PRS-Resource-ID CRITICALITY ignore EXTENSION PRS-Resource-ID
PRESENCE optional },
...
iE-Extensions ProtocolExtensionContainer { {
PRSFrequencyHoppingConfiguration-EUTRA-Item-IEs} } OPTIONAL,
...
PRS-Measurements-Info-List ::= SEQUENCE (SIZE(1..maxFreqLayers)) OF
...
measurementPRSLength ENUMERATED {ms1dot5, ms3, ms3dot5, ms4, ms5dot5,
ms6, ms10, ms20},

iE-Extensions ProtocolExtensionContainer { {
PRS-Measurements-Info-List-Item-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { { PRSMuting-ExtIEs} }
OPTIONAL,
...
PRSResource-List::= SEQUENCE (SIZE (1..maxnoofPRSresource)) OF
PRSResource-Item
...
iE-Extensions ProtocolExtensionContainer { {
PRSResource-QCLSourceSSB-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
PRSResource-QCLSourcePRS-ExtIEs} } OPTIONAL,
...
PRSTransmissionOffPerResource ::= SEQUENCE (SIZE
(1..maxnoofPRSresourceSet)) OF PRSTransmissionOffPerResource-Item
...
iE-Extensions ProtocolExtensionContainer { {
PRSTransmissionOffPerResource-Item-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
PRSTransmissionOffInformation-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
PRSTransmissionOffPerResourceSet-Item-ExtIEs} } OPTIONAL,
...
\-- The IE shall be present if the PRS Configuration Request Type IE is
set to "configure" \--
...
iE-Extensions ProtocolExtensionContainer { { PRSTRPItem-ExtIEs} }
OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
PRSTransmissionTRPItem-ExtIEs} } OPTIONAL,
...
iE-extensions ProtocolExtensionContainer
{{RelativeGeodeticLocation-ExtIEs }} OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
RelativeCartesianLocation-ExtIEs} } OPTIONAL,
...
RepetitionFactorExtended ::= ENUMERATED {n3, n5, n6, n7, n8, n10, n12,
n14, \...}
...
RequestedDLPRSResourceSet-List ::= SEQUENCE (SIZE
(1..maxnoofPRSresourceSet)) OF RequestedDLPRSResourceSet-Item
...
iE-Extensions ProtocolExtensionContainer { {
RequestedDLPRSResourceSet-Item-ExtIEs} } OPTIONAL,
...
RequestedDLPRSResource-List::= SEQUENCE (SIZE (1..maxnoofPRSresource))
...
iE-Extensions ProtocolExtensionContainer { {
RequestedDLPRSResource-Item-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
ResourceSetTypePeriodic-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
ResourceSetTypeSemi-persistent-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
ResourceSetTypeAperiodic-ExtIEs} } OPTIONAL,
...
periodicity ENUMERATED{slot1, slot2, slot4, slot5, slot8, slot10,
slot16, slot20, slot32, slot40, slot64, slot80, slot160, slot320,
slot640, slot1280, slot2560, \...},

offset INTEGER(0..2559, \...),

iE-Extensions ProtocolExtensionContainer { {
ResourceTypePeriodic-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
ResourceTypeSemi-persistent-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
ResourceTypeAperiodic-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
ResourceTypePeriodicPos-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
ResourceTypeSemi-persistentPos-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
ResourceTypeAperiodicPos-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { { ResponseTime-ExtIEs} }
OPTIONAL,
...
ResultCSI-RSRP ::= SEQUENCE (SIZE (1.. maxCellReportNR)) OF
ResultCSI-RSRP-Item
...
iE-Extensions ProtocolExtensionContainer { {
ResultCSI-RSRP-PerCSI-RS-Item-ExtIEs} } OPTIONAL,
...
ResultCSI-RSRQ ::= SEQUENCE (SIZE (1.. maxCellReportNR)) OF
ResultCSI-RSRQ-Item
...
iE-Extensions ProtocolExtensionContainer { {
ResultCSI-RSRQ-PerCSI-RS-Item-ExtIEs} } OPTIONAL,
...
ResultRSRP-EUTRA ::= SEQUENCE (SIZE (1.. maxCellReport)) OF
...
iE-Extensions ProtocolExtensionContainer { {
ResultRSRP-EUTRA-Item-ExtIEs} } OPTIONAL,
...
ResultRSRQ-EUTRA ::= SEQUENCE (SIZE (1.. maxCellReport)) OF
...
iE-Extensions ProtocolExtensionContainer { {
ResultRSRQ-EUTRA-Item-ExtIEs} } OPTIONAL,
...
ResultSS-RSRP ::= SEQUENCE (SIZE (1.. maxCellReportNR)) OF
ResultSS-RSRP-Item
...
ResultSS-RSRP-PerSSB ::= SEQUENCE (SIZE (1.. maxIndexesReport)) OF
...
iE-Extensions ProtocolExtensionContainer { {
ResultSS-RSRP-PerSSB-Item-ExtIEs} } OPTIONAL,
...
ResultSS-RSRQ ::= SEQUENCE (SIZE (1.. maxCellReportNR)) OF
ResultSS-RSRQ-Item
...
ResultSS-RSRQ-PerSSB ::= SEQUENCE (SIZE (1.. maxIndexesReport)) OF
...
iE-Extensions ProtocolExtensionContainer { {
ResultSS-RSRQ-PerSSB-Item-ExtIEs} } OPTIONAL,
...
RxTxTimingErrorMargin ::= ENUMERATED {tc0dot5, tc1, tc2, tc4, tc8, tc12,
tc16, tc20, tc24, tc32, tc40, tc48, tc64, tc80, tc96, tc128, \...}
...
iE-Extensions ProtocolExtensionContainer { {
Search-window-information-ExtIEs } } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
SpatialDirectionInformation-ExtIEs } } OPTIONAL,
...
SpatialRelationforResourceID ::= SEQUENCE
(SIZE(1..maxnoSpatialRelations)) OF SpatialRelationforResourceIDItem
...
iE-Extensions ProtocolExtensionContainer { {
SpatialRelationPerSRSResource-ExtIEs} } OPTIONAL,
...
SpatialRelationPerSRSResource-List::= SEQUENCE(SIZE (1..
maxnoSRS-ResourcePerSet)) OF SpatialRelationPerSRSResourceItem
...
iE-Extensions ProtocolExtensionContainer {
{SpatialRelationPerSRSResourceItem-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { { SRSConfig-ExtIEs } }
OPTIONAL,
...
SRSCarrier-List ::= SEQUENCE (SIZE(1.. maxnoSRS-Carriers)) OF
...
iE-Extensions ProtocolExtensionContainer { { SRSResource-ExtIEs } }
OPTIONAL,
...
{ ID id-nrofSymbolsExtended CRITICALITY ignore EXTENSION
...
{ ID id-StartRBHopping CRITICALITY ignore EXTENSION StartRBHopping
PRESENCE optional}\|
...
SRSResource-List ::= SEQUENCE (SIZE (1..maxnoSRS-Resources)) OF
SRSResource
...
iE-Extensions ProtocolExtensionContainer { { SSBInfoItem-ExtIEs} }
OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
StartTimeAndDuration-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
TDD-Config-EUTRA-Item-Item-ExtIEs } } OPTIONAL,
...
iE-extensions ProtocolExtensionContainer { { RxTxTEG-ExtIEs } }
OPTIONAL,
...
iE-extensions      ProtocolExtensionContainer { { RxTEG-ExtIEs } }
OPTIONAL,
...
TimingErrorMargin ::= ENUMERATED {tc0, tc2, tc4, tc6, tc8, tc12, tc16,
tc20, tc24, tc32, tc40, tc48, tc56, tc64, tc72, tc80, \...}
...
\-- The value kHz60 is not supported in this version of the
specification.
...
iE-Extension ProtocolExtensionContainer { { TimeStamp-ExtIEs} }
OPTIONAL,
...
{ ID id-transmissionCombn8 CRITICALITY reject TYPE TransmissionCombn8
PRESENCE mandatory},
...
iE-Extensions ProtocolExtensionContainer {{
TRPBeamAntennaInformation-ExtIEs}} OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer {{
TRP-BeamAntennaExplicitInformation-ExtIEs}} OPTIONAL,
...
TRP-BeamAntennaAngles ::= SEQUENCE (SIZE (1.. maxnoAzimuthAngles)) OF
...
trp-elevation-angle-list SEQUENCE (SIZE (1.. maxnoElevationAngles)) OF
TRP-ElevationAngleList-Item,

iE-Extensions ProtocolExtensionContainer {{
TRP-BeamAntennaAnglesList-Item-ExtIEs}} OPTIONAL,
...
trp-beam-power-list SEQUENCE (SIZE (2..maxNumResourcesPerAngle)) OF
TRP-Beam-Power-Item,

iE-Extensions ProtocolExtensionContainer {{
TRP-ElevationAngleList-Item-ExtIEs}} OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer {{
TRPMeasurementQuantitiesList-Item-ExtIEs}} OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer
{{TrpMeasurementResultItem-ExtIEs}} OPTIONAL,
...
{ ID id-SRSResourcetype CRITICALITY ignore EXTENSION SRSResourcetype
PRESENCE optional}\|

{ ID id-ARP-ID CRITICALITY ignore EXTENSION ARP-ID PRESENCE optional}\|

{ ID id-LoS-NLoSInformation CRITICALITY ignore EXTENSION
...
{ ID id-UL-SRS-RSRPP CRITICALITY reject TYPE UL-SRS-RSRPP PRESENCE
mandatory},
...
iE-extensions ProtocolExtensionContainer { {
TrpMeasurementTimingQuality-ExtIEs } } OPTIONAL,
...
iE-extensions ProtocolExtensionContainer { {
TrpMeasurementAngleQuality-ExtIEs } } OPTIONAL,
...
TRP-MeasurementRequestList ::= SEQUENCE (SIZE (1..maxNoOfMeasTRPs)) OF
...
iE-extensions ProtocolExtensionContainer { {
TRP-MeasurementRequestItem-ExtIEs } } OPTIONAL,
...
{ ID id-NumberOfTRPRxTxTEG CRITICALITY ignore EXTENSION
...
TRP-MeasurementResponseList ::= SEQUENCE (SIZE (1..maxNoOfMeasTRPs)) OF
...
iE-extensions ProtocolExtensionContainer { {
TRP-MeasurementResponseItem-ExtIEs } } OPTIONAL,
...
TRP-MeasurementUpdateList ::= SEQUENCE (SIZE (1..maxNoOfMeasTRPs)) OF
...
iE-extensions ProtocolExtensionContainer { {
TRP-MeasurementUpdateItem-ExtIEs } } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer {
{TRPInformationTRPResp-ExtIEs} } OPTIONAL,
...
TRPInformationTypeResponseList ::= SEQUENCE (SIZE
(1..maxnoTRPInfoTypes)) OF TRPInformationTypeResponseItem
...
TRPInformationTypeListTRPReq ::= SEQUENCE (SIZE(1.. maxnoTRPInfoTypes))
OF ProtocolIE-Single-Container { {TRPInformationTypeItemTRPReq} }
...
iE-extensions ProtocolExtensionContainer { {
TRPPositionReferenced-ExtIEs } } OPTIONAL,
...
TRP-PRS-Information-List ::= SEQUENCE (SIZE(1.. maxnoPRSTRPs)) OF
...
iE-Extensions ProtocolExtensionContainer { {
TRP-PRS-Information-List-Item-ExtIEs} } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
TRP-Rx-TEGInformation-ExtIEs } } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
TRP-RxTx-TEGInformation-ExtIEs } } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
TRP-Tx-TEGInformation-ExtIEs } } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { { TRPTEGItem-ExtIEs } }
OPTIONAL,
...
iE-extensions ProtocolExtensionContainer { {
UEReportingInformation-ExtIEs } } OPTIONAL,
...
iE-Extensions ProtocolExtensionContainer { {
UETxTEGAssociationItem-ExtIEs } } OPTIONAL,
...
{ ID id-UETxTimingErrorMargin CRITICALITY ignore EXTENSION
TimingErrorMargin PRESENCE optional },
...
{ ID id-TRP-Rx-TEGInformation CRITICALITY ignore EXTENSION
...
iE-extensions ProtocolExtensionContainer { { UL-SRS-RSRPP-ExtIEs } }
OPTIONAL,
...
UplinkChannelBW-PerSCS-List ::= SEQUENCE (SIZE (1..maxnoSCSs)) OF
SCS-SpecificCarrier
...
ngran-access (22) modules (3) nrppa (4) version1 (1) nrppa-Containers
(5)}
...
NRPPA-PROTOCOL-IES : IEsSetParam} ::=
...
ProtocolExtensionContainer { NRPPA-PROTOCOL-EXTENSION :
ExtensionSetParam} ::=
...
criticality NRPPA-PROTOCOL-EXTENSION.&criticality
({ExtensionSetParam}{\@id}),

extensionValue NRPPA-PROTOCOL-EXTENSION.&Extension
({ExtensionSetParam}{\@id})
...
NRPPa shall use the ASN.1 Basic Packed Encoding Rules (BASIC-PER)
Aligned Variant as transfer syntax, as specified in ref. ITU-T Rec.
X.691 \[6\].
...
Section 10 of TS 38.413 \[2\] is applicable for the purposes of the
present document, with the following additions:

\- In case of Abstract Syntax Error, when reporting the *Criticality
Diagnostics* IE for not comprehended IE/IE groups or missing IE/IE
groups, the *NRPPa* *Transaction ID* IE shall also be included;

\- In case of Logical Error, when reporting the *Criticality
Diagnostics* IE, the *NRPPa* *Transaction ID* IE shall also be included.
...
|        |        |        |      |     |     | omment | ersion |
+--------+--------+--------+------+-----+-----+--------+--------+
| 2017   | RA     | R3-    |      |     |     | TS     | v0.0.0 |
| -08-23 | N3\#97 | 173238 |      |     |     | sk     |        |
|        |        |        |      |     |     | eleton |        |
|        |        |        |      |     |     | agreed |        |
+--------+--------+--------+------+-----+-----+--------+--------+
| 2017   | RA     | R3-    |      |     |     | TS     | v0.1.0 |
| -08-25 | N3\#97 | 173374 |      |     |     | 38.455 |        |
|        |        |        |      |     |     | V0.1.0 |        |
+--------+--------+--------+------+-----+-----+--------+--------+
| 2017   | RAN3\  | R3-    |      |     |     | Imple  | V0.2.0 |
| -10-18 | #97bis | 173979 |      |     |     | mented |        |
|        |        |        |      |     |     | agreed |        |
|        |        |        |      |     |     | pCR    |        |
|        |        |        |      |     |     | from   |        |
|        |        |        |      |     |     | R3\    |        |
|        |        |        |      |     |     | #97bis |        |
+--------+--------+--------+------+-----+-----+--------+--------+
| 