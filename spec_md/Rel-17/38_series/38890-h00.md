...
OAM sends the deactivation indication to NG-RAN node to indicate which
...
The mobility procedure adaptation for signalling-based vs.
...
For solution 2, Slice Scope may be inside of the QoE configuration
